<%@ Page Title="" Language="C#" MasterPageFile="~/Publica.master" AutoEventWireup="true" CodeFile="webConsultaProblemas.aspx.cs" Inherits="Pantallas_Problemas_webConsultaProblemas" EnableEventValidation = "false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <br />
    <asp:Label ID="lblencconpro" runat="server" Font-Bold="True" Font-Size="Large" 
        Text="<%$ Resources:resCorpusCFDIEs, lblencconpro%>"></asp:Label>
...
&nbsp;<asp:Button ID="btnNuevoProblema" runat="server" 
                    ...
                    onclick="btnNuevoProblema_Click" CssClass="botonGrande" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Timer 
                    ID="Timer2" runat="server" Interval="300000" ontick="Timer2_Tick">
                </asp:Timer>
                &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;</td>
            <td>
                &nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td class="style9">
                            <asp:DropDownList ID="ddlestatus" runat="server" Height="20px" Width="210px">
                                <asp:ListItem Value="N">(Seleccione Opcion)</asp:ListItem>
            ...
            <td>
                ...
                BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" PageSize="1000" 
                    ...
                    AllowSorting="True" onsorting="gdvIncidencias_Sorting" BackColor="White">
                        ...
                        HeaderStyle-HorizontalAlign="Left" SortExpression="ticket_problema">
                                <ItemTemplate>
                        ...
                        SortExpression="descripcion">
                            ...
                            <asp:TemplateField HeaderText="<%$ Resources:resCorpusCFDIEs, lblTipoProblema %>" 
            ...
            <td>
                <asp:Panel ID="Panel12" runat="server" BackColor="White" BorderColor="Black" 
                    ...
                    <table class="style11">
                        ...
                        <tr>
                            <td class="style42">
                                <asp:Label ID="lblticket1" runat="server" 
                                Text="<%$ Resources:resCorpusCFDIEs, lblticket %>"></asp:Label>
                            </td>
                        </tr>
                        <tr>
