<%@ Page Title="Registro de Incidencias" Language="C#" MasterPageFile="~/Publica.master" AutoEventWireup="true" CodeFile="webCatalogoIncidencias.aspx.cs" Inherits="Pantallas_Incidentes_RegistroIncidencias" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <br />
    <asp:Label ID="lblenccatinc" runat="server" Font-Bold="True" Font-Size="Large" 
        Text="<%$ Resources:resCorpusCFDIEs, lblenccatinc %>"></asp:Label>
    ...
    <table style="width: 99%;">
        <tr>
            <td class="style7">
                <asp:Label ID="lblTipoIncidencia" runat="server" Text="<%$ Resources:resCorpusCFDIEs, lblTipoIncidencia%>"></asp:Label>
            </td>
            <td class="style8">
                &nbsp;</td>
        </tr>
