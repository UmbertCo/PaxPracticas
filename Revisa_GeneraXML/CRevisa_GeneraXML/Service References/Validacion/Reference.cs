...
namespace CRevisa_GeneraXML.Validacion {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://test.paxfacturacion.com.mx:453", ConfigurationName="Validacion.wcfRecepcionASMXSoap")]
    public interface wcfRecepcionASMXSoap {
        ...
        CRevisa_GeneraXML.Validacion.fnEnviarXMLResponse fnEnviarXML(CRevisa_GeneraXML.Validacion.fnEnviarXMLRequest request);
    }
    ...
    public partial class fnEnviarXMLRequest {
        ...
        public CRevisa_GeneraXML.Validacion.fnEnviarXMLRequestBody Body;
        
        public fnEnviarXMLRequest() {
        }
        
        public fnEnviarXMLRequest(CRevisa_GeneraXML.Validacion.fnEnviarXMLRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class fnEnviarXMLResponse {
        ...
        public CRevisa_GeneraXML.Validacion.fnEnviarXMLResponseBody Body;
        
        public fnEnviarXMLResponse() {
        }
        
        public fnEnviarXMLResponse(CRevisa_GeneraXML.Validacion.fnEnviarXMLResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface wcfRecepcionASMXSoapChannel : CRevisa_GeneraXML.Validacion.wcfRecepcionASMXSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class wcfRecepcionASMXSoapClient : System.ServiceModel.ClientBase<CRevisa_GeneraXML.Validacion.wcfRecepcionASMXSoap>, CRevisa_GeneraXML.Validacion.wcfRecepcionASMXSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CRevisa_GeneraXML.Validacion.fnEnviarXMLResponse CRevisa_GeneraXML.Validacion.wcfRecepcionASMXSoap.fnEnviarXML(CRevisa_GeneraXML.Validacion.fnEnviarXMLRequest request) {
        ...
        public string fnEnviarXML(string psComprobante, string psTipoDocumento, int pnId_Estructura, string sNombre, string sContraseña, string sVersion) {
            CRevisa_GeneraXML.Validacion.fnEnviarXMLRequest inValue = new CRevisa_GeneraXML.Validacion.fnEnviarXMLRequest();
            inValue.Body = new CRevisa_GeneraXML.Validacion.fnEnviarXMLRequestBody();
            ...
            CRevisa_GeneraXML.Validacion.fnEnviarXMLResponse retVal = ((CRevisa_GeneraXML.Validacion.wcfRecepcionASMXSoap)(this)).fnEnviarXML(inValue);
