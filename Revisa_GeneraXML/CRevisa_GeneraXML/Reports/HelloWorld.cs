...
namespace ReportSamples {
  ...
  class HelloWorld {
    ...
    public  void hello() {
        ...
        //Report rPrueba1 = new Report(new PdfFormatter());
        //FontDef fd = new FontDef(rPrueba1, "Arial");
        //FontProp fp = new FontProp(fd, 30.0);
        //Page pCanvas = new Page(rPrueba1);
        //pCanvas.AddCentered(80, new RepString(fp, "Hello World!"));
        //RT.ViewPDF(rPrueba1, "Hello.pdf");
