...
public class clsOperacionArticulos
{
    ...
    public int fnUpdateArticulo(int pId_Articulo, string psDescripcion, string psMedida, double pPrecio, string pIva, double pIeps
        , double pIsr, double pIvaRetenido, string psMoneda, string psEstatus, int pIdEstructura, string pnClave, double pnISH, double pnCNG)
    {
        ...
        giSql.AgregarParametro("@nISH", pnISH);
        giSql.AgregarParametro("@nCNG", pnCNG);
