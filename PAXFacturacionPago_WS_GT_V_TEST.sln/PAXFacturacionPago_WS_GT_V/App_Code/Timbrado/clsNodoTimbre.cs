...
public class clsNodoTimbre
{
    ...
    public void GenerarNodoAddenda32(Comprobante pComprobante, XmlDocument  xDoc, string NodoAddenda)
    {
    ...
    /// <param name="xDoc"></param>
    /// <param name="NodoAddenda"></param>
    public void GenerarNodoAddenda30(Comprobante30 pComprobante, XmlDocument xDoc, string NodoAddenda)
    {
        XmlDocument Addenda = new XmlDocument();
