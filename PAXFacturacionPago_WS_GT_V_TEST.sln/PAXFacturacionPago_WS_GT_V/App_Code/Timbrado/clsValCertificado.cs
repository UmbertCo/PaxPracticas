...
public class clsValCertificado
{
    ...
    /// <summary>
    /// Busca el cerrificado de PAC fisicamente.
    /// </summary>
    /// <param name="noCertificado"></param>
    /// <returns></returns>
    public bool fnVerificarExistenciaCertificadoPAC(string noCertificado)
    {
    ...
    /// <summary>
    /// Revisa caducidad del certificado en la CSD
    /// </summary>
    /// <param name="no_serie"></param>
    /// <param name="estado_cerR"></param>
    /// <param name="estado_cerC"></param>
    /// <returns></returns>
    public string RevisaCaducidadCertificadoCSD(string no_serie, string estado_cerR, string estado_cerC)
    {
        ...
        try
        {
            ...
            sRetorno = Convert.ToString(conexion.TraerEscalar("usp_Ctp_RevisarCaducidadCSDV2", true));
    ...
    /// </summary>
    /// <returns></returns>
    public bool ComprobarFechasV(DateTime dFechaComprobante)
    {

        if (certificado.NotBefore.CompareTo(dFechaComprobante) > 0
            || certificado.NotAfter.CompareTo(dFechaComprobante) < 0)
            return false;
    ...
    /// </summary>
    /// <returns></returns>
    public bool ComprobarFechasV2(DateTime dFechaComprobante)
    {
