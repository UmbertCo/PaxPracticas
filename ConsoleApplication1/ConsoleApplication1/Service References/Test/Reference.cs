...
namespace ConsoleApplication1.Test {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://test.paxfacturacion.com.mx:453", ConfigurationName="Test.wcfRecepcionASMXSoap")]
    public interface wcfRecepcionASMXSoap {
        ...
        ConsoleApplication1.Test.fnEnviarXMLResponse fnEnviarXML(ConsoleApplication1.Test.fnEnviarXMLRequest request);
    }
    ...
    public partial class fnEnviarXMLRequest {
        ...
        public ConsoleApplication1.Test.fnEnviarXMLRequestBody Body;
        
        public fnEnviarXMLRequest() {
        }
        
        public fnEnviarXMLRequest(ConsoleApplication1.Test.fnEnviarXMLRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class fnEnviarXMLResponse {
        ...
        public ConsoleApplication1.Test.fnEnviarXMLResponseBody Body;
        
        public fnEnviarXMLResponse() {
        }
        
        public fnEnviarXMLResponse(ConsoleApplication1.Test.fnEnviarXMLResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface wcfRecepcionASMXSoapChannel : ConsoleApplication1.Test.wcfRecepcionASMXSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class wcfRecepcionASMXSoapClient : System.ServiceModel.ClientBase<ConsoleApplication1.Test.wcfRecepcionASMXSoap>, ConsoleApplication1.Test.wcfRecepcionASMXSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ConsoleApplication1.Test.fnEnviarXMLResponse ConsoleApplication1.Test.wcfRecepcionASMXSoap.fnEnviarXML(ConsoleApplication1.Test.fnEnviarXMLRequest request) {
        ...
        public string fnEnviarXML(string psComprobante, string psTipoDocumento, int pnId_Estructura, string sNombre, string sContraseña, string sVersion) {
            ConsoleApplication1.Test.fnEnviarXMLRequest inValue = new ConsoleApplication1.Test.fnEnviarXMLRequest();
            inValue.Body = new ConsoleApplication1.Test.fnEnviarXMLRequestBody();
            ...
            ConsoleApplication1.Test.fnEnviarXMLResponse retVal = ((ConsoleApplication1.Test.wcfRecepcionASMXSoap)(this)).fnEnviarXML(inValue);
