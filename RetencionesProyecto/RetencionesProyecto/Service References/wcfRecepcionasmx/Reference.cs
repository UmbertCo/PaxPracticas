...
namespace RetencionesProyecto.wcfRecepcionasmx {
    ...
    public interface wcfRecepcionASMXSoap {
        ...
        RetencionesProyecto.wcfRecepcionasmx.fnEnviarXMLResponse fnEnviarXML(RetencionesProyecto.wcfRecepcionasmx.fnEnviarXMLRequest request);
    }
    ...
    public partial class fnEnviarXMLRequest {
        ...
        public RetencionesProyecto.wcfRecepcionasmx.fnEnviarXMLRequestBody Body;
        
        public fnEnviarXMLRequest() {
        }
        
        public fnEnviarXMLRequest(RetencionesProyecto.wcfRecepcionasmx.fnEnviarXMLRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class fnEnviarXMLResponse {
        ...
        public RetencionesProyecto.wcfRecepcionasmx.fnEnviarXMLResponseBody Body;
        
        public fnEnviarXMLResponse() {
        }
        
        public fnEnviarXMLResponse(RetencionesProyecto.wcfRecepcionasmx.fnEnviarXMLResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface wcfRecepcionASMXSoapChannel : RetencionesProyecto.wcfRecepcionasmx.wcfRecepcionASMXSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class wcfRecepcionASMXSoapClient : System.ServiceModel.ClientBase<RetencionesProyecto.wcfRecepcionasmx.wcfRecepcionASMXSoap>, RetencionesProyecto.wcfRecepcionasmx.wcfRecepcionASMXSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        RetencionesProyecto.wcfRecepcionasmx.fnEnviarXMLResponse RetencionesProyecto.wcfRecepcionasmx.wcfRecepcionASMXSoap.fnEnviarXML(RetencionesProyecto.wcfRecepcionasmx.fnEnviarXMLRequest request) {
        ...
        public string fnEnviarXML(string psComprobante, int psCveRetencion, int pnId_Estructura, string sNombre, string sContrasena, string sVersion) {
            RetencionesProyecto.wcfRecepcionasmx.fnEnviarXMLRequest inValue = new RetencionesProyecto.wcfRecepcionasmx.fnEnviarXMLRequest();
            inValue.Body = new RetencionesProyecto.wcfRecepcionasmx.fnEnviarXMLRequestBody();
            ...
            RetencionesProyecto.wcfRecepcionasmx.fnEnviarXMLResponse retVal = ((RetencionesProyecto.wcfRecepcionasmx.wcfRecepcionASMXSoap)(this)).fnEnviarXML(inValue);
