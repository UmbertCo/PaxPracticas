...
using RetencionesProyecto.wsLicenciaASMX;
using RetencionesProyecto.wcfRecepcionasmx;
using RetencionesProyecto.wcfValidaASMX;
using OpenSSL_Lib;
...
namespace RetencionesProyecto
{
    public partial class MyFileSystemWatcher : FileSystemWatcher
    {
        ...
        private void Init()//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            {
                clsLog.Escribir(Settings.Default.LogError + "LogError", DateTime.Now + " " + "Error al iniciar el servicio. " + ex.Message);
            }
        }
        ...
        private string fnGenerarComprobante(string sLayout, string sNombreLayout)//////////////////////////////////////////////////////////////////////////////////////////////////////////
        {
            ...
            try
            {
                ...
                string sTipoFirmado = fnObtenerMetodoFirmadoCertificado(certEmisor);
                ...
                //Valida sello
                if (!fnVerificarSello(sCadenaOriginalEmisor, sSello, sTipoFirmado))
                {
        ...
        public string Validador(string XML, string Clasificacion)
        {
            try
            {
                ...
                settings.Schemas.Add(null, XmlReader.Create(AppDomain.CurrentDomain.BaseDirectory + "\\esquemas\\" + Clasificacion + ".xsd"));
