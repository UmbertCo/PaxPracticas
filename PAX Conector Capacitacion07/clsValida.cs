    ...
    class clsValida
    {
        ...
        private static string Valida_con_XSD(byte[] yXML)
        {
            ...
            try
            {
                ...
                oSchemaSet.Add(null, @"C:\PAXConectorCapacitacion07\xsd\cfdv33.xsd");
                oSchemaSet.Add(null, @"C:\PAXConectorCapacitacion07\xsd\catCFDI.xsd");
                oSchemaSet.Add(null, @"C:\PAXConectorCapacitacion07\xsd\tdCFDI.xsd");
                oSchemaSet.Compile();
