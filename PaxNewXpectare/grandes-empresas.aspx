<%@ Page Language="C#" AutoEventWireup="true" CodeFile="grandes-empresas.aspx.cs" Inherits="grandes_empresas" MasterPageFile="MasterPage.master"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
      <section id="banner">
        	<div class="container">
            	<div class="row">
					<div class="span12">
                    	<img src="img/grandes-empresas.jpg" alt=""/>
                    </div><!-- .span12 -->
                </div><!-- .row -->
            </div><!-- .container -->
        </section>
        ...
        <section id="main">
        	<div class="container">
            	<div class="row fix">
                	<div class="span12">
                    	<p class="breadcrumb"><a href="/">Home</a> / <span>Grandes Empresas</span></p>
                        <div class="separador"></div>
                        <h1>Grandes Empresas</h1>
                        <div class="row">
                        	<div class="span8 block-green">
                                <h2>Tenemos la infraestructura tecnológica para soportar tu operación.</h2>
                                ...
                                <ol style="padding:0 58px;">
                                    <li>Estamos comprometidos a ofrecerle la mejor ATENCIÓN, SERVICIO y SEGURIDAD que su empresa necesita. Obteniendo su confianza y satisfacción.</li>
                                    ...
                                    <li>Cuenta con la SEGURIDAD de estar contratando a un equipo capaz de brindar un servicio de alta calidad, disponibilidad y eficiencia a un BAJO COSTO.</li>
