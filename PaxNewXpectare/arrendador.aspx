...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
      <section id="banner">
        	<div class="container">
            	<div class="row">
					<div class="span12">
                    	<img src="img/arrendador.jpg" alt=""/>
                    </div><!-- .span12 -->
                </div><!-- .row -->
            </div><!-- .container -->
        </section>
        ...
        <section id="main">
        	<div class="container">
            	<div class="row">
                	<div class="span12">
                    	<p class="breadcrumb"><a href="/">Home</a> / <span>Arrendador</span></p>
                        <div class="separador"></div>
                        <h1>Soluciones para Arrendador</h1>
                        <div class="row">
                        	<div class="span8 block-green">
                                <h4>Facturación electrónica para ti:</h4>
                                <div class="encabezado-contenido">
                                    <div class="icono-encabezado-contenido">
                                        <img src="img/arrendador-icon.gif" alt=""/>
                                    </div>
                                    <div class="texto-encabezado-contenido">
                                        <p>Cuando tus ingresos sean por dar en renta o alquiler edificios, locales comerciales, casas habitación, departamentos habitacionales, bodegas, entre otros y lo haces a través de un Código Bidimensional o CFD, es momento de cambiar a Comprobante Fiscal Digital por Internet.<br/><br/>
                                        En 2014 todos los arrendatarios deben de usar este método para expedir sus comprobantes fiscales.</p>
                                    </div>
                                </div>
                               <div style="clear:both;hieght:1px;">&nbsp;</div>
                                <ul>
                                    <li>Te ofrecemos la oportunidad de expedir estos comprobantes para tus inquilinos o arrendatarios de una manera sencilla y práctica.</li>
                                    <li>¿Cómo obtenerlos?
                                        <ol>
