<%@ Page Language="C#" AutoEventWireup="true" CodeFile="personas-fisicas.aspx.cs" Inherits="personas_fisicas" MasterPageFile="MasterPage.master"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
      <section id="banner">
        	<div class="container">
            	<div class="row">
					<div class="span12">
                    	<img src="img/personas-fisicas.jpg" alt=""/>
                    </div><!-- .span12 -->
                </div><!-- .row -->
            </div><!-- .container -->
        </section>
        ...
        <section id="main">
        	<div class="container">
            	<div class="row">
                	<div class="span12">
                    	<p class="breadcrumb"><a href="/">Home</a> / <span>Personas Físicas</span></p>
                        <div class="separador"></div>
                        <h1>Personas Físicas</h1>
                        <div class="row fix">
                        	<div class="span8 block-green">
                                <h2>Tan completo como tener un sistema de información, y tan simple como llenar una factura a mano.</h2>
                                ...
                                <ol style="padding:0 58px;">
                                    <li>Deja los trámites tediosos, nosotros nos encargamos de ellos.</li>
                                    <li>Si buscas ATENCIÓN, SERVICIO Y SEGURIDAD, somos tu opción como persona física.</li>
                                    ...
                                    <li>Cuentas con la SEGURIDAD de estar contratando a un equipo capaz de brindar un servicio de alta calidad, disponibilidad y eficiencia a un BAJO COSTO.</li>
