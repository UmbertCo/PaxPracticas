...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" Runat="Server">
        <section id="banner">
        	<div class="container">
            	<div class="row">
					<div class="span12">
                    	<img src="img/profesionista.jpg" alt=""/>
                    </div><!-- .span12 -->
                </div><!-- .row -->
            </div><!-- .container -->
        </section>
        ...
        <section id="main">
        	<div class="container">
            	<div class="row">
                	<div class="span12">
                    	<p class="breadcrumb"><a href="/">Home</a> / <span>Profesionista</span></p>
                        	...
                        	<div class="span8 block-green">
                                ...
                                <div class="encabezado-contenido">
                                    <div class="icono-encabezado-contenido">
                                        <img src="img/profesionista-icon.gif" alt=""/>
                                    </div>
                                    <div class="texto-encabezado-contenido">
                                        <p>Profesionista si <span id="azul">facturas</span> o haces <span id="Span1">recibos de honorarios</span> a tus clientes o en tu lugar de trabajo y lo haces a través de un Codigo Bidimensional, es momento de cambiar a Comprobante Fiscal Digital por Internet.<br/>
                                        En 2014 todos los profesionistas deben de usar este método para sus comprobantes fiscales.</p>
                                    </div>
                                </div>
                                <ul>
                                	<li>Te ofrecemos la oportunidad de expedir estos comprobantes de una manera sencilla y práctica, y de esa manera poder tener un control sobre tus ingresos.</li>
                                    <li>¿Cómo obtenerlos?
                                        <ol>
