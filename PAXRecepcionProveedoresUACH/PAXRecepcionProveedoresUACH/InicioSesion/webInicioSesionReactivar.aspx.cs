...
public partial class InicioSesion_webInicioSesionReactivar : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {

    }
    protected void btnReactivarCuenta_Click(object sender, EventArgs e)
    {
        ...
        if (registro.buscarClaveExistente(txtUsuario.Text.Trim(), txtCorreo.Text.Trim()) != 0)
        {
            ...
            if (registro.actualizaContraseña(txtUsuario.Text.Trim(), txtCorreo.Text.Trim(), Utilerias.Encriptacion.Base64.EncriptarBase64(sPassword)))
            {
                ...
                strMensaje = "<table>";
                strMensaje = strMensaje + "<tr><td><b>Al Contribuyente:</b></td><td>Se le ha enviado un correo para reactivar la contraseña, presione el link que se muestra a continuación.</td></tr>";
                ...
                if (sendEmail.EnviarCorreo(txtCorreo.Text, Resources.resCorpusCFDIEs.msgReactivaCon, strMensaje + " " + clsComun.ObtenerParamentro("urlHostCosto")))
                {
                    ...
                    Response.Redirect("webInicioSesionCorrecto.aspx?tpResult=Reactivar");
                }
                else
                {
