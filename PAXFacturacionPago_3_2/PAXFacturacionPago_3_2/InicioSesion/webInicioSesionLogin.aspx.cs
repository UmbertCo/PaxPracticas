...
public partial class Account_Login : System.Web.UI.Page
{
    ...
    protected void btnEntrar_Click(object sender, EventArgs e)
    {
        ...
        if (tabla.Rows.Count > 0)
        {
            ...
            if (origen != 'C')
            {
                //clsComun.fnMostrarMensaje(this, Resources.resCorpusCFDIEs.varOrigUsu, Resources.resCorpusCFDIEs.varContribuyente);
                clsComun.fnMostrarMensaje(this, Resources.resCorpusCFDIEs.varUsuPassInv);
                clsPistasAuditoria.fnGenerarPistasAuditoria(datosUsuario.id_usuario, DateTime.Now, this.Title + "|" + sClientIP + "|" + "buscarUsuario" + "|" + userName.Text.Trim() + "|" + "El usuario no corresponde al sistema designado.");
                return;
            }

            //Revisa contraseña
            //if (Password.Text == Utilerias.Encriptacion.Classica.Desencriptar(tabla.Rows[0]["password"].ToString()))            
    ...
    protected void btnBloqueo_Click(object sender, EventArgs e)
    {
        ...
        if (tabla.Rows.Count > 0)
        {
            ...
            if (txtPasswordBloq.Text == PAXCrypto.CryptoAES.DesencriptaAES((byte[])tabla.Rows[0]["password"]))
            {
