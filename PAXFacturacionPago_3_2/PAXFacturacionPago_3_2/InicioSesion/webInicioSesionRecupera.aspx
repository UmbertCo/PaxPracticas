<%@ Page Title="Recupera" Language="C#" MasterPageFile="~/webGlobalMaster.master" AutoEventWireup="true" CodeFile="webInicioSesionRecupera.aspx.cs" Inherits="InicioSesion_webInicioSesionRecupera" %>
        ...
        <center>
            <h2>
                <asp:Label ID="lblRecuperaCuenta" runat="server" 
                    Text="<%$ Resources:resCorpusCFDIEs, lblRecuperaCuenta %>"></asp:Label>
            </h2>
            <p>
                <asp:Label ID="lblRecupera" runat="server" Text="<%$ Resources:resCorpusCFDIEs, lblDetRecupera %>"></asp:Label>
            </p>
            <br />
            <br />
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btnCrearCuenta" runat="server" CommandName="MoveNext" 
                                ...
                                onclick="btnRecuperaCuenta_Click" TabIndex="5" CssClass="botonGrande" Height="30px" />
                        </td>
                        <td></td>
                    </tr>
                </table>
