...
/// <summary>
/// Pantalla para la configuración de series para le uso interno del emisor.
/// Estas series podrán ser usadas la momento de facturar y consultar pero no intervienen en el proceso del timbrado
/// </summary>
