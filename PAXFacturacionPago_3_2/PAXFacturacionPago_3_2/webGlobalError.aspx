<%@ Page Title="" Language="C#" MasterPageFile="~/webGlobalMaster.master" AutoEventWireup="true" CodeFile="webGlobalError.aspx.cs" Inherits="webGlobalError" %>
        ...
        <tr>
            <td align="center" >
                <asp:HyperLink ID="lnkHome" runat="server" 
                    NavigateUrl="~/InicioSesion/webInicioSesionLogin.aspx" Text="<%$ Resources:resCorpusCFDIEs, hlkRegresar %>"></asp:HyperLink>
            </td>
        </tr>
    </table>
</asp:Content>
