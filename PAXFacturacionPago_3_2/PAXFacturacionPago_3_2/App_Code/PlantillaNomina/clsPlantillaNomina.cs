...
public class clsPlantillaNomina
{
    ...
    private Page fnDibujaPanelSumaDeducciones(ref double incapacidadY, ref Page pagina, Report reporte, int id_contribuyente, int s_Id_Rfc)
    {
        ...
        sSumaDeducciones = Convert.ToString(Convert.ToDouble(sDescuento, new CultureInfo("es-Mx")) + Convert.ToDouble(this.sISR, new CultureInfo("es-Mx")), new CultureInfo("es-Mx"));
    ...
    private void fnDatosPanelSello(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, StaticContainer panel, double Renglon)
    {
        ...
        double tamRenglon = 5;
        //panel.AddAligned(margenPagina + 5, RepObj.rAlignLeft, 677, RepObj.rAlignBottom, new RepString(fPropChica, sSelloEmisor));
        fnAgregarMultilinea(panel, sSelloEmisor, fPropChica, margenPagina + 5, 676 + tamRenglon, 150, true);
        //panel.AddAligned(margenPagina + 5, RepObj.rAlignLeft, 705, RepObj.rAlignBottom, new RepString(fPropChica, sSelloSat));
        fnAgregarMultilinea(panel, sSelloSat, fPropChica, margenPagina + 5, 704 + tamRenglon, 150, true);
        //panel.AddAligned(margenPagina + 5, RepObj.rAlignLeft, 735, RepObj.rAlignBottom, new RepString(fPropChica, sCadenaOriginal));
        fnAgregarMultilinea(panel, sCadenaOriginal, fPropChica, margenPagina + 5, 734 + tamRenglon, 150, true);
        ...
        i = fnAgregarMultilinea(panel, sSelloSat, fPropChica, margenPagina + 5, posRenglon + tamRenglon * Renglon + 640, 150, true);
        Renglon += i;

        i = fnAgregarMultilinea(panel, sCadenaOriginal, fPropChica, margenPagina + 5, posRenglon + tamRenglon * Renglon + 640, 150, true);
        Renglon += i;*/
    }
