...
public class clsErrorLog
{
    ...
    //        psObservaciones = "Ubicado en Pagina de Cobro";
    //    }
    //    catch
    //    {
    ...
    //                scoComando.Parameters.AddWithValue("sMensaje", pExcepcion.Message);

    //                scoComando.Parameters.AddWithValue("sModulo", infoLoc[0]);
    //                scoComando.Parameters.AddWithValue("sMetodo", infoLoc[1]);
    ...
    public static void fnNuevaEntrada(Exception pExcepcion, TipoErroresLog pTipoError, string psObservaciones, int pnId_Usuario)
    {
        ...
        sUbicacion = "Ubicado en Pagina de Cobro";
    ...
    {
        if (!EventLog.SourceExists("PortalCobro"))
        {
            EventLog.CreateEventSource("PortalCobro", "PortalCobroLog");
        }

        EventLog PaxEventLog = new EventLog();
        PaxEventLog.Source = "PortalCobro";
