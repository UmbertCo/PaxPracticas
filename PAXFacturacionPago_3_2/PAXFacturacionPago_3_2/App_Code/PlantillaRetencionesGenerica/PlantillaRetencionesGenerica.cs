...
using System.Configuration;
    ...
    class PlantillaRetencionesGenerica
    {
        public Report PDF;
...
// ARGUMENTOS OPCIONALES
           ...
           StaticContainer Pie, int nNumPag, int nTotPag, string sColor, XmlDocument gxComprobante)
        {
           ...
           //CHECAR
            ...
            if (nNumPag == nTotPag)//Si es ultima pagina
            {
                ...
                string sCadenaComplemento = Transformacion.fnConstruirCadenaTimbrado(gxComprobante.CreateNavigator().SelectSingleNode("/retenciones:Retenciones/retenciones:Complemento/tfd:TimbreFiscalDigital", nsmComprobante).CreateNavigator(), "cadenaoriginal_TFD_1_0");
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////
    ...
    public class clsErrorLogPDFRet
    {
        //private static clsInicioSesionUsuario gUsuario;

        public clsErrorLogPDFRet()
        {
        }
