...
public class clsOperacionEmpleados
{
    ...
    /// <returns></returns>
    public bool fnActualizarEmpleado(int pnId_Empleado, string psNombre, byte[] psCorreo, byte[] psRegistroPatronal, int pnRiesgoPuesto,
                                    string psNumeroEmpleado, byte[] psCURP, string psRFC, int pnBanco, byte[] psCLABE, int pnTipoRegimen,
                                    byte[] psNumeroSeguridadSocial, string psDepartamento, string psPuesto, string psTipoContrato, 
                                    string psTipoJornada, DateTime pdFechaInicialRelacionLaboral,
                                    byte[] pdSalarioBase, byte[] pdSalarioDiarioIntegrado, int pnId_Estructura, char psEstatus)
    {
    ...
    /// <param name="psEstatus"></param>
    /// <returns></returns>
    public bool fnIngresarEmpleado(string psNombre, byte[] psCorreo, byte[] psRegistroPatronal, int pnRiesgoPuesto,
                                    string psNumeroEmpleado, byte[] psCURP, string psRFC, int pnBanco, byte[] psCLABE, int pnTipoRegimen,
                                    byte[] psNumeroSeguridadSocial, string psDepartamento, string psPuesto, string psTipoContrato,
                                    string psTipoJornada, DateTime pdFechaInicialRelacionLaboral,
                                    byte[] pdSalarioBase, byte[] pdSalarioDiarioIntegrado, int pnId_Estructura, char psEstatus)
        ...
        using (SqlConnection scConexion = new SqlConnection())
        {
            try
            {
                ...
                using (SqlCommand scoComando = new SqlCommand())
                {
                    ...
                    scoComando.Parameters.AddWithValue("nid_estructura", pnId_Estructura);
                    scoComando.Parameters.AddWithValue("sEstatus", "A");
