...
public class clsPlantillaGeneraldeSeguros
{
	...
	private void fnTotales(XmlNamespaceManager nsmComprobante, XPathNavigator navPie, StaticContainer Pie, int nNumPag, int nTotPag, string sColor)
	{
        ...
        //Pie.AddAligned(Pie.rWidth / 7, RepObj.rAlignCenter, Pie.rHeight - verPadding, RepObj.rAlignTop, new RepString(fPropNormal, clsComun.ObtenerParamentro("urlHostComercial")));
    ...
    private void fnDatosEmisor(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, StaticContainer Encabezado, System.Drawing.Color sColor, ref double Renglon)
	{
        ...
        dPosXpnl += -125;
        fnAgregarMultilinea(Encabezado, "PAGO EN UNA SOLA EXHIBICION ", fPropNormal, Encabezado.rWidth - dPosXpnl, fAltoPanel / 1.5, 40, true);
    ...
    private void fnDatosReceptor(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, StaticContainer Encabezado, double Renglon)
	{
        ...
        fnAgregarMultilinea(Encabezado, "AV. PATRIOTISMO NO. 266   COL. SAN PEDRO DE LOS PINOS C.P ", fPropNormal, leftPadding, posRenglon + tamRenglon * Renglon, 75, true);
        //salto de linea
        Renglon += 0.19;
        fnAgregarMultilinea(Encabezado, "DELEG. BENITO JUAREZ ", fPropNormal, leftPadding, posRenglon + tamRenglon * Renglon, 75, true);
        //salto de linea
        Renglon += 0.19;
        fnAgregarMultilinea(Encabezado, "MEXICO , D.F. ", fPropNormal, leftPadding, posRenglon + tamRenglon * Renglon, 75, true);
        ...
        //Mueve posion en X
        dPosTituX += dPosTituX;
        fnAgregarMultilinea(Encabezado, "MUENCHENER RUCKVERSICHERUNGS GESELLSCHAFT ", fPropNormal, leftPadding + dPosTituX, posRenglon + tamRenglon * Renglon, 75, true);
        //salto de linea
        dRenglon = 0.18;
        Renglon += dRenglon;
        ...
        //Mueve posion en X
        dPosDesX += dPosDesX;
        fnAgregarMultilinea(Encabezado, "JOSE MA. VELASCO NO. 30 COL. SAN JOSE INSURGENTES ", fPropNormal, leftPadding + dPosDesX, posRenglon + tamRenglon * Renglon, 75, true);
        //salto de linea
        Renglon += dRenglon;
        fnAgregarMultilinea(Encabezado, "DELEG. BENITO JUAREZ , MEXICO, D.F. ", fPropNormal, leftPadding + dPosDesX, posRenglon + tamRenglon * Renglon, 75, true);
        //salto de linea
        Renglon += dRenglon;
        fnAgregarMultilinea(Encabezado, "R.F.C. ", fPropNegrita, leftPadding, posRenglon + tamRenglon * Renglon, 75, true);
       
        fnAgregarMultilinea(Encabezado, "xxx999999xxx ", fPropNormal, leftPadding + dPosDesX, posRenglon + tamRenglon * Renglon, 75, true);
        //salto de linea
        dRenglon = 0.6;
        Renglon += dRenglon;
        fnAgregarMultilinea(Encabezado, "CONTRATO No. ", fPropNegrita, leftPadding, posRenglon + tamRenglon * Renglon, 75, true);
       
        fnAgregarMultilinea(Encabezado, "2320 ", fPropNormal, leftPadding + dPosDesX, posRenglon + tamRenglon * Renglon, 75, true);

        fnAgregarMultilinea(Encabezado, "RAMO: ", fPropNegrita, leftPadding + dPosTituX, posRenglon + tamRenglon * Renglon, 75, true);

        fnAgregarMultilinea(Encabezado, "0050 INCENDIO ", fPropNormal, leftPadding + dPosTituX + 80, posRenglon + tamRenglon * Renglon, 75, true);
        //salto de linea
        dRenglon = 0.18;
        Renglon += dRenglon;
        fnAgregarMultilinea(Encabezado, "NOMBRE DEL CONTRATO: ", fPropNegrita, leftPadding, posRenglon + tamRenglon * Renglon, 75, true);

        fnAgregarMultilinea(Encabezado, "3937 1ER EXCEDENTE -11 INCENDIO REASEGURO CEDIDO ", fPropNormal, leftPadding + dPosDesX, posRenglon + tamRenglon * Renglon, 75, true);
...
public class clsErrorLogGeneraldeSeguros
{
    //private static clsInicioSesionUsuario gUsuario;
    public clsErrorLogGeneraldeSeguros()
    {
    }
...
public class clsComunLogo
{
    ...
    public static string ObtenerParamentro(string sParametro)
    {
        ...
        using (SqlConnection con = new SqlConnection(PAXCrypto.CryptoAES.DesencriptaAES64(ConfigurationManager.ConnectionStrings["conControl"].ConnectionString)))
        {
            ...
            {
                con.Close();
                clsErrorLogGeneraldeSeguros.fnNuevaEntrada(ex, clsErrorLogGeneraldeSeguros.TipoErroresLog.Conexion);
            }
        }
        return sRetorno;
    }
