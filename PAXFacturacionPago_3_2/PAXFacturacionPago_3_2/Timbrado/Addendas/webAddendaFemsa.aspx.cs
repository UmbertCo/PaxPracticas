...
public partial class Addendas_Ejemplo : System.Web.UI.Page
{
    ...
    public string ArmarXML()
    {
        ...
        peticion.ChildNodes[0].ChildNodes[0].ChildNodes[2].InnerText = tbSociedad.Text;
