...
public partial class Timbrado_Addendas_webAddendaAHMSA : System.Web.UI.Page
{
    ...
    private string fnArmarXml()
    {
        ...
        if (!string.IsNullOrEmpty(txtNumProveedor.Text))
        {
            if (txtNumProveedor.Text.Length >= 6)
            {
                try
                {
                    ...
                    {
                        clsComun.fnMostrarMensaje(this, "El número de proveedor es incorrecto");
                        return null;
                    }
                }
            ...
            {
                clsComun.fnMostrarMensaje(this, "El número de proveedor debe ser mayor a 6 dígitos");
                return null;
            }
        }
        else
        {
            clsComun.fnMostrarMensaje(this, "El número de proveedor es requerido");
            return null;
        }
        string correo = txtCorreo.Text;
        if (!clsComun.fnValidaExpresion(correo, @"\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"))
        {
            clsComun.fnMostrarMensaje(this, "El correo es incorrecto");
            return null;
        }
        ...
        if (fnServiciosRequeridos())
        {
            if (pedidos == null)
            {
                clsComun.fnMostrarMensaje(this, "Falto agregar una recepción en uno de los pedidos");
                return null;
            }
            if (pedidos.Length.Equals(0))
            {
                clsComun.fnMostrarMensaje(this, "Debe agregar al menos un pedido debido al tipo y clase que seleccionó");
                return null;
            }
        }
        ...
        {
            clsComun.fnMostrarMensaje(this, "La hoja de servicio es requerida por el tipo y clase de documento");
            return null;
        }
        //---- Transporte
        ...
        {
            clsComun.fnMostrarMensaje(this, "El número de transporte es requerida por el tipo y clase de documento");
            return null;
        }
        if (!string.IsNullOrEmpty(transporteNum))
        {
            ...
            {
                clsComun.fnMostrarMensaje(this, "El número de transporte debe ser de mínimo 7 dígitos");
                return null;
            }
        }
            ...
            ddlClase.SelectedValue=="KT")
        {
            ...
            {
                clsComun.fnMostrarMensaje(this, "El número de cuenta por pagar es requerido por los datos seleccionados");
                return null;
            }
            if (string.IsNullOrEmpty(txtEjCtaxPag.Text))
            {
                clsComun.fnMostrarMensaje(this, "El número de ejercicio de cuenta por pagar es requerido por los datos seleccionados");
                return null;
            }
        }
        if (!string.IsNullOrEmpty(ctaxPagNum))
        {
            ...
            {
                clsComun.fnMostrarMensaje(this, "El número de cuenta por pagar debe ser igual a 10 dígitos");
                return null;
            }
            try
            {
                ...
                if (nCtaxPagNum <= 0)
                {
                    clsComun.fnMostrarMensaje(this, "El número de cuenta por pagar debe ser mayor a cero");
                    return null;
                }
            }
            catch (Exception ex)
            {
                clsComun.fnMostrarMensaje(this, "El número de cuenta por pagar debe ser númerico");
                return null;
            }
        }
        ...
        if (!string.IsNullOrEmpty(txtEjCtaxPag.Text))
        {
            ...
            {
                clsComun.fnMostrarMensaje(this, "El ejercicio de cuenta por pagar debe ser igual a 4 dígitos");
                return null;
            }
            ...
            try
            {
                ...
                {
                    clsComun.fnMostrarMensaje(this, "El número de ejercicio de cuenta por pagar debe ser mayor a cero");
                    return null;
                }
            }
            catch (Exception ex)
            {
                clsComun.fnMostrarMensaje(this, "El número de ejercicio de cuenta por pagar debe ser númerico");
                return null;
            }
        }
        ...
        if (ddlTipoDocumento.SelectedValue == "2" && ddlClase.SelectedValue == "CO")
        {
            ...
            {
                clsComun.fnMostrarMensaje(this, "Ambas fechas son requeridas por el tipo y clase de documento");
                return null;
            }
        }
    ...
    protected void btnAgrServicio_Click(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(numServicio))
        {
            ...
            {
                clsComun.fnMostrarMensaje(this, "El numero de pedido debe ser igual a 10 dígitos");
                return;
            }
            ...
            {
                clsComun.fnMostrarMensaje(this, "Debe ser un valor numérico");
                return;
            }
            ...
            {
                clsComun.fnMostrarMensaje(this, "No debe exceder de 20 pedidos");
            }
        }
    }
        ...
        if (trvServicios.SelectedNode!=null)
        {
            ...
            if (!string.IsNullOrEmpty(numRecepcion))
            {
                if (trvServicios.SelectedNode.Parent == null)
                {
                    ...
                    {
                        clsComun.fnMostrarMensaje(this, "El numero de recepción debe ser igual a 10 dígitos");
                        return;
                    }
                    ...
                    {
                        clsComun.fnMostrarMensaje(this, "No debe exceder de 20 recepciones por pedido");
                    }
                }
            }
        }
