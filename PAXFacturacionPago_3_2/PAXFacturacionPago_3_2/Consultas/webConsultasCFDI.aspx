            ...
            <div class="accountInfo textos" style="width:900px;">
                <fieldset class="register" style="width:890px;">
                    ...
                    <table style="width: 860px">
                        <tr>
                            <td>
                                <asp:Label ID="lblComprobanteFiscal" runat="server" 
                                    Text="<%$ Resources:resCorpusCFDIEs, lblComprobanteFiscal %>" 
                                    AssociatedControlID="ddlSucursales" Height="17px"></asp:Label>
                            ...
                            <td>
                                <asp:Label ID="lblOrigen" runat="server" 
                                    Text="<%$ Resources:resCorpusCFDIEs, lblOrigen %>" 
                                    AssociatedControlID="ddlOrigen"></asp:Label>
                                <asp:DropDownList ID="ddlOrigen" runat="server">
                                    <asp:ListItem Value="C">Portal</asp:ListItem>
                                    <asp:ListItem Value="R">WebService</asp:ListItem>
                                    <asp:ListItem Value="I">FTP</asp:ListItem>
                                    <asp:ListItem Value="IG">CFDI Grande</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="style2">
                                ...
                                <asp:Label ID="lblUsuario" runat="server" 
                                    ...
                                    AssociatedControlID="ddlUsuarios"></asp:Label>
                        ...
                        <tr>
                            <td>
                              ...
                              <asp:Label ID="lblRFCEmisor" runat="server" Text="<%$ Resources:resCorpusCFDIEs, lblRFCEmisor %>" AssociatedControlID="txtRFCEmisor"></asp:Label>
                              <asp:TextBox ID= "txtRFCEmisor" runat="server" ValidationGroup="grupoRfc"  MaxLength = "128"></asp:TextBox>
                                 <asp:RegularExpressionValidator ID="regxRFC" runat="server" 
                                        ControlToValidate="txtRFCEmisor" CssClass="failureNotification" Display="Dynamic" 
                            ...
                            <td>
                                <asp:Label ID="lblRFCReceptor" runat="server" Text="<%$ Resources:resCorpusCFDIEs, lblRFCReceptor %>" AssociatedControlID="txtRFCReceptor"></asp:Label>
                                <asp:TextBox ID= "txtRFCReceptor" runat="server"  MaxLength = "128" Text=""></asp:TextBox>

                                <asp:RegularExpressionValidator ID="regxRFCReceptor" runat="server" 
                                        ControlToValidate="txtRFCReceptor" CssClass="failureNotification" Display="Dynamic" 
                                        ToolTip="RFC incompleto" 
                                        ValidationExpression="[A-Z,Ñ,&amp;]{3,4}[0-9]{2}[0-1][0-9][0-3][0-9][A-Z,0-9][A-Z,0-9][0-9,A]" 
                                        ValidationGroup="grupoRfc"><img src="../Imagenes/error_sign.gif" /></asp:RegularExpressionValidator>
                            </td>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:TextBox ID="txtSerie" runat="server" MaxLength="19" Width="100px"></asp:TextBox>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td>
                                ...
                                <asp:Label ID="lblReceptor" runat="server" 
                                    ...
                                    AssociatedControlID="ddlReceptor" Visible="False"></asp:Label>
                            ...
                            <td>
                                <asp:Label ID="lblFolioFin" runat="server" 
                                    ...
                                    AssociatedControlID="txtFolioFin" Visible="False"></asp:Label>
                                <asp:TextBox ID="txtFolioFin" runat="server" MaxLength="19" Width="100px" 
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                ...
                <p style="text-align:right;" >
                    <asp:Label ID="lblMensaje" runat="server" 
                        Text="Por el momento algunos filtros estarán deshabilitados para su uso en la consulta." 
                     ...
                     <asp:GridView ID="gdvComprobantes" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="origen" 
                                HeaderText="<%$ Resources:resCorpusCFDIEs, lblOrigen %>" 
                                HeaderStyle-HorizontalAlign="Left" >
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="Usuario" 
                                HeaderText="<%$ Resources:resCorpusCFDIEs, lblUser %>" 
                                HeaderStyle-HorizontalAlign="Left" >
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Emisor" 
                                HeaderText="<%$ Resources:resCorpusCFDIEs, lblEmisorRFC  %>" 
                                HeaderStyle-HorizontalAlign="Left" >
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            <asp:BoundField DataField="Receptor" 
                                HeaderText="<%$ Resources:resCorpusCFDIEs, lblReceptorRFC %>" 
                                HeaderStyle-HorizontalAlign="Left" >
                            <HeaderStyle HorizontalAlign="Left" />
                            </asp:BoundField>
                            ...
                            <asp:BoundField DataField="fechaTimbrado" 
                                HeaderText="<%$ Resources:resCorpusCFDIEs, lblFechaTimbrado %>" HeaderStyle-HorizontalAlign="Left"
                                DataFormatString="{0:d}" >
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Width="70px" />
                            </asp:BoundField>
                            <asp:BoundField DataField="fechaEmision" 
                                HeaderText="<%$ Resources:resCorpusCFDIEs, lblFechaGeneracion %>" HeaderStyle-HorizontalAlign="Left"
                                DataFormatString="{0:d}" >
                            <HeaderStyle HorizontalAlign="Left" />
                            <ItemStyle Width="70px" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField ShowHeader="False">
                                <ItemTemplate>
                                    <asp:LinkButton ID="hpCancelar" runat="server" CausesValidation="False" 
                                         CommandArgument='<%# Eval("id_cfd") %>' Visible='<%# Convert.ToString(Eval("estatus")) == "A" %>'
                            ...
                            <asp:TemplateField Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="lblrazon_social" runat="server" Text='<%# Bind("razon_social") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <EmptyDataTemplate>
