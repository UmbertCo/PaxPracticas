...
public partial class Consultas_WebDescargaComprobantesV2 : System.Web.UI.Page
{
    ...
    protected void btnDescarga_Click(object sender, EventArgs e)
    {
        ...
        ParametrosThreadDescargaV2 parametrosThreadDescarga = new ParametrosThreadDescargaV2();
    ...
    private void fnThreadDescargaComprobantes(object data)
    {
        try
        {
            ...
            ParametrosThreadDescargaV2 parametrosThreadDescarga = (ParametrosThreadDescargaV2)data;
            //Se recupera session
            ...
            foreach (DataRow renglon in dtComprobantes.Rows)
            {
                ...
                try
                {
                    ...
                    //Se genera una excepción ya que al obtener la sesión regresa null
...
class ParametrosThreadDescargaV2
{
