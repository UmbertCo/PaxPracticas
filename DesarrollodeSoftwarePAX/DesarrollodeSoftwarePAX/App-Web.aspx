<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="App-Web.aspx.cs" Inherits="App_Web" %>
    ...
    <table class="hojaPrincipal">
        ...
        <tr>
            ...
            <td rowspan="4" align="center" style="text-align: center" 
              ...
              Text = "<%$ Resources:resCorpusCFDIEs, lblTextoAppWeb %>" Font-Bold="False" 
