<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="App-Escritorio.aspx.cs" Inherits="App_Escritorio" %>
    ...
    <table class="hojaPrincipal">
        ...
        <tr>
            ...
            <td rowspan="4" align="center" style="text-align: center" 
              ...
              Text = "<%$ Resources:resCorpusCFDIEs, lblTextoAppEscritorio %>" Font-Bold="False" 
