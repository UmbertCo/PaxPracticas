...
<td class ="ManoFondo">
    ...
    <table style="width: 965px; height: 233px" >
        <tr>
            <td align="left" class="style7" style="text-align: left">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="titulo" runat="server" Font-Bold="True" Font-Size="X-Large" 
                    ForeColor="#A5D10F" Text="<%$ Resources:resCorpusCFDIEs, lblTerminos %>" 
                    style="font-family: 'Century Gothic'" Width="500px"></asp:Label>
                <br />
                <br />
            </td>
        </tr>
        <tr>
            <td align="right" valign="top">
                ...
                <asp:Label ID="texto" runat="server" ForeColor="#395C6C" Font-Bold="False" 
