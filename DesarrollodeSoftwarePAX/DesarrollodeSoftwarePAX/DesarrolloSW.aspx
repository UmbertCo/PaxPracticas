<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DesarrolloSW.aspx.cs" Inherits="DesarrolloSW" %>
 ...
 <table class="hojaPrincipal">
        <tr>
            ...
            <td class="style1" height="30px">
              ...
              Text = "<%$ Resources:resCorpusCFDIEs, lblTituloDesarrolloDeSW %>" Font-Bold="True" 
              Font-Size="XX-Large" ForeColor="#395C6C" Font-Names="Arial" 
              style="color: #A5D10F; text-align: left;" Width="400px" Height="30px"></asp:Label>
                &nbsp;</td>
            <td class="style2">
                &nbsp;</td>
            <td class="DesarrolloSW" rowspan="5" height="200px" width="480px">
                &nbsp;</td>
            <td>
                &nbsp;</td>
        </tr>
        <tr>
            ...
            <td rowspan="4" align="center" style="text-align: center" 
              ...
              Text = "<%$ Resources:resCorpusCFDIEs, lblTextoDesarrolloDeSW %>" Font-Bold="False" 
