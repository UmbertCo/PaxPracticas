<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Web_Service.aspx.cs" Inherits="Web_Service" %>
   ...
   <table class="hojaPrincipal">
        ...
        <tr>
            ...
            <td rowspan="4" align="center" style="text-align: center" 
              ...
              Text = "<%$ Resources:resCorpusCFDIEs, lblTextoWebService %>" Font-Bold="False" 
