<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="App-Moviles.aspx.cs" Inherits="App_Moviles" %>
    ...
    <table class="hojaPrincipal">
        ...
        <tr>
            ...
            <td rowspan="4" align="center" style="text-align: center" 
              ...
              Text = "<%$ Resources:resCorpusCFDIEs, lblTextoAppMoviles %>" Font-Bold="False" 
