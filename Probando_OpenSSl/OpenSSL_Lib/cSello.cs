...
namespace OpenSSL_Lib
{
    public class cSello
    {
        ...
        public cSello(string psRutaKey, string psRutaPass,string psRutaGeneracion)
        {
            ...
            _sRutaOpenSSL = psRutaGeneracion;
        ...
        /// <param name="psRutaKey">Ruta Llave</param>
        /// <param name="psRutaPass">Ruta Pass</param>
        public cSello(string psRutaKey, string psRutaPass, string psRutaGeneracion,string psRutaInstalacion)
        {
            _sRutaKey = psRutaKey;
            _sRutaPass = psRutaPass;
            _sRutaGeneracionArchivos = psRutaGeneracion;
            ...
            cRevisar_Generar.fnInstalar(psRutaInstalacion);
        ...
        /// <param name="psPass">Contraseña</param>
        /// <param name="pbBytesLlave">Arreglo de Bytes de la Llave</param>
        public cSello(string psPass, byte[] pbBytesLlave, string psRutaGeneracion,string psRutaInstalacion)
        {
            Digestion = enuMetodoDigestion.SHA1;
            ...
            _sRutaOpenSSL = psRutaInstalacion ;
        ...
        public cSello(string psPass, byte[] pbBytesLlave, string psRutaGeneracion,String psRutaInstalacion, enuMetodoDigestion pmdDigestion)
        {
            Digestion = pmdDigestion;
        ...
        private void fnCrearArchivoKey() 
        {
                ...
                _sNombreArchivoLlave =_sRutaGeneracionArchivos+ "Key" + Guid.NewGuid().ToString().Replace("-","").ToUpper() + ".key";
        ...
        private void fnCrearPemLlave()
        {
            ...
            _sNombreArchivoPemLlave =_sRutaGeneracionArchivos+ "LlavePEM" + Guid.NewGuid().ToString().Replace("-","").ToUpper()+ ".pem";
                ...
                if (!File.Exists(_sNombreArchivoPemLlave))
                {
                    pProceso.Dispose();
                throw new OpenSSLException(enuEstatus.PERMISOS,"No se pudo crear el archivo PEM (fnCrearPemLlave): " + _sNombreArchivoPemLlave);
                ...
                {
                    pProceso.Dispose();
                    throw new OpenSSLException(enuEstatus.ERROPENSSL, "Existio un error en la creacion del archivo PEM (fnCrearPemLlave): " + _sNombreArchivoPemLlave);
                }
        ...
        private void fnCrearArchivoCadenaOriginal()
        {
            ...
            _sNombreArchivoCadenaOriginal =_sRutaGeneracionArchivos+ "CO" + Guid.NewGuid().ToString().Replace("-","").ToUpper() + ".txt";
        ...
        private void fnCrearArchivoBin() 
        {
            ...
            _sNombreArchivoBin=_sRutaGeneracionArchivos+ "BIN" + Guid.NewGuid().ToString().Replace("-","").ToUpper() + ".txt";
            ...
            if (!File.Exists(_sNombreArchivoBin))
            {
                pProceso.Dispose();
                throw new OpenSSLException(enuEstatus.PERMISOS, "No se pudo crear el archivo BIN (fnCrearArchivoBin): " + _sNombreArchivoBin);
            ...
            {
                pProceso.Dispose();
                throw new OpenSSLException(enuEstatus.ERROPENSSL, "Existio un error en la creacion del archivo BIN (fnCrearArchivoBin): " + _sNombreArchivoBin);
            }
        ...
        private void fnCrearSello() 
        {
            ...
            _sNombreArchivoSello =_sRutaGeneracionArchivos+ "Sello" + Guid.NewGuid().ToString().Replace("-","").ToUpper() + ".txt";
            ...
            if (!File.Exists(_sNombreArchivoSello))
            {
                pProceso.Dispose();
                throw new OpenSSLException(enuEstatus.PERMISOS, "No se pudo crear el archivo Sello (fnCrearSello): " + _sNombreArchivoSello);
            ...
            {
                pProceso.Dispose();
                throw new OpenSSLException(enuEstatus.ERROPENSSL, "Existio un error en la creacion del archivo Sello (fnCrearSello): " + _sNombreArchivoSello);
            }
            pProceso.Dispose();
        }
