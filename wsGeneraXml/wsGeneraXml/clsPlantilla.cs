...
namespace wsGeneraXml
{
    class clsPlantilla
    {
        ...
        //tamaños en puntos
        private const double altoEncabezado = 65;
        ...
        public clsPlantilla(XmlDocument pxComprobante)
        {
        ...
        public void fnGenerarPDF(int id_contribuyente, int sid_rfc, string scolor)
        {
            ...
            List<DetalleMyers> detallesNum = fnObtenerDetalles();
            ...
            List<DetalleMyers> detalles = fnObtenerDetalles();
            ...
            while (bSeguir)
            {
                ...
                ms = fnImagenCliente("MYERS_Logo.png");
        ...
        /// <returns></returns>
        private StaticContainer fnContarPaginas(List<DetalleMyers> detalles)
        {
            ...
            DetalleMyers[] copiaDetalles = detalles.ToArray();
            DetalleMyers d;
            double posRenglon;
            ...
            for (int i = 0; renglonActual <= maxRenglones; i++)
            {
                ...
                if (d.aduana != null || !String.IsNullOrEmpty(d.RfcT))
                {
                    ...
                    if (!String.IsNullOrEmpty(d.RfcT))
                    {
                        ...
                        if ((d.RetencionesT != null && d.RetencionesT.Count > 0) || (d.TrasladosT != null && d.TrasladosT.Count > 0)) //Impuestos tercero
                        {
                            ...
                            {
                                foreach (ComprobanteImpuestosRetencionTMyers retencion in d.RetencionesT)
                                {
                                    switch (retencion.impuesto)
                                    {
                                        case ComprobanteImpuestosRetencionImpuestoTMyers.IVA: sDetalleTerceros.Append("IVA Ret: "); break;
                                        case ComprobanteImpuestosRetencionImpuestoTMyers.ISR: sDetalleTerceros.Append("ISR: "); break;
                                    }
                                    sDetalleTerceros.Append(TransformacionMyers.fnFormatoCurrency(retencion.importe.ToString()) + " ");
                                }
                            }

                            if (d.TrasladosT != null && d.TrasladosT.Count > 0)
                            {
                                foreach (ComprobanteImpuestosTrasladoTMyers traslado in d.TrasladosT)
                                {
                                    switch (traslado.impuesto)
                                    {
                                        case ComprobanteImpuestosTrasladoImpuestoTMyers.IVA: sDetalleTerceros.Append("IVA Tras "); break;
                                        case ComprobanteImpuestosTrasladoImpuestoTMyers.IEPS: sDetalleTerceros.Append("IEPS "); break;
                                    }
                                    sDetalleTerceros.Append(TransformacionMyers.fnFormatoPorcentaje(traslado.tasa.ToString()) + ": ");
                                    sDetalleTerceros.Append(TransformacionMyers.fnFormatoCurrency(traslado.importe.ToString()) + " ");
                                }
                            }
                        }
                ...
                {
                    Col1 = fnContarMultilinea(areaDetalle, d.descripcion, fPropNormal, posColumna1, posRenglon, 42, true);
                    Col2 = fnAgregarMultilinea(areaDetalle, d.noIdentificacion, fPropNormal, posColumna2, posRenglon, 9, true);
                    Col3 = fnAgregarMultilinea(areaDetalle, d.unidad, fPropNormal, posColumna3, posRenglon, 9, true);
        ...
        public void fnGenerarPDFSave(string ruta, string scolor)
        {
            ...
            while (bSeguir)
            {
                ...
                RepObj link = new RepString(fPropNormal, Settings.Default.urlHostComercial);
                link.RotateTransform(270);
                pagina.Add(margenPagina - 10, pagina.rHeight / 2, link);
                //pagina.Add(margenPagina - 10, pagina.rHeight / 2, new RepString(fPropNormal, Settings.Default.urlHostComercial));

                fPropNormal = new FontProp(fuenteNormal, tamFuenteNormal);
                RepObj leyenda = new RepString(fPropNormal, leyendaPDF);
                leyenda.RotateTransform(270);
                pagina.Add(pagina.rWidth - (margenPagina - 10), (pagina.rHeight / 2) + (leyenda.rHeight / 3), leyenda);
                ...
                //MemoryStream ms = new MemoryStream();
                //ms = fnImagenCliente("MYERS_Logo.JPG");
        ...
        /// <returns></returns>
        private StaticContainer fnCrearDetalle(List<DetalleMyers> detalles, System.Drawing.Color sColor)
        {
            StaticContainer areaDetalle = new StaticContainer(RT.rPointFromMM(anchoPagina) - margenPagina * 2, RT.rPointFromMM(altoPagina - altoEncabezado - altoPie) - margenPagina * 2);
            ...
            double posColumna2 = areaDetalle.rWidth * 0.37;
            double posColumna3 = areaDetalle.rWidth * 0.56; //0.2;
            double posColumna4 = areaDetalle.rWidth * 0.73;
            double posColumna5 = areaDetalle.rWidth * 0.85;
            double posColumna6 = areaDetalle.rWidth * 0.96;
            int renglones = 0;
            double a = 0;
            //maxRenglones = 50;
            //Mediante el for controlamos el numero de renglones para el detalle
            ...
            for (int i = 0; renglonActual <= maxRenglones; i++)
            {
                ...
                {
                    Col1 = fnAgregarMultilineaDetalle(areaDetalle, d.descripcion, fPropNormal, posColumna1, posRenglon, 42, true);
                    Col2 = fnAgregarMultilinea(areaDetalle, d.noIdentificacion, fPropNormal, posColumna2, posRenglon, 9, true);
                    Col3 = fnAgregarMultilinea(areaDetalle, d.unidad, fPropNormal, posColumna3, posRenglon, 9, true);
        ...
        private List<DetalleMyers> fnObtenerDetalles()
        {
            ...
            {
                detalles.Add(new DetalleMyers(navDetalles.Current, nsmComprobante));
                ...
                if (nodenavigator.HasChildren)//Si contiene nodo hijo
                {
                    ...
                    if (navDetallesAduana != null)
                        detalles.Add(new DetalleMyers(navDetallesAduana, nsmComprobante));
                    ...
                    if (navComplTerceros != null)
                    {
                        ...
                        if (navTerceros != null)
                            detalles.Add(new DetalleMyers(navTerceros, nsmComprobanteComplTerceros));
                    }
                }
            }
        ...
        {
            string catalogo = Resources.catalogo;
            string atributos = string.Empty;
            XmlDocument xXML = new XmlDocument();
            xXML.LoadXml(catalogo);
            XmlNodeList listaMetodosPago = xXML.GetElementsByTagName("mp:ListaMetodosPago");
            XmlNodeList metodosPago = ((XmlElement)listaMetodosPago[0]).GetElementsByTagName("mp:MetodosPago");
            XmlNodeList metodos = ((XmlElement)metodosPago[0]).GetElementsByTagName("mp:MetodoPago");
            int elemento = 0;
            string[] smetodosPago = navPie.SelectSingleNode("/cfdi:Comprobante/@metodoDePago", nsmComprobante).Value.Split(',');

            foreach (XmlElement nodo in metodos)
            {

                string sClave = nodo.GetAttribute("Clave");
                atributos = atributos + sClave + "@";
                string sDescripcion = nodo.GetAttribute("Descripcion");
                atributos = atributos + sDescripcion + "|";
            }

            atributos = atributos.TrimEnd('|');

            string[] satributo = atributos.Split('|');
            ...
            List<ImpuestoMyers> impuestos = new List<ImpuestoMyers>();
            List<ImpuestoCompMyers> impuestosComp = new List<ImpuestoCompMyers>();
            ...
            try
            {
                foreach (string m in smetodosPago)
                {
                    foreach (string a in satributo)
                    {
                        string[] valores = a.Split('@');

                        if (m.ToString().Equals(valores[0]) || m.ToString().Equals(valores[1]))
                        {
                            if (metodoPago.Equals(""))
                                metodoPago = metodoPago + valores[0] + "-" + valores[1];
                            else
                                metodoPago = metodoPago + ", " + valores[0] + "-" + valores[1];
                            break;
                        }
                        ...
                        {
                            if (elemento < satributo.Length - 1)
                            {
                                elemento += 1;
                                continue;
                            }
            ...
            if (nNumPag == nTotPag)//Si es ultima pagina
            {
                ...
                {
                    impuestos.Add(new ImpuestoMyers(navImpuestos.Current, nsmComprobante));
                }
            ...
            try
            {
                ...
                {
                    impuestosComp.Add(new ImpuestoCompMyers(navComplemento.Current, nsmComprobante));
                }
            ...
            if (nNumPag == nTotPag)//Si es ultima pagina
            {
                ...
                Pie.AddAligned(Pie.rWidth - horPadding, RepObj.rAlignRight, verPadding, RepObj.rAlignTop, new RepString(fPropNormal, TransformacionMyers.fnFormatoCurrency(subtotal)));
            }
            ...
            if (nNumPag == nTotPag)//Si es ultima pagina
            {
                if (descuento != string.Empty)
                {
                    ...
                    Pie.AddAligned(Pie.rWidth - horPadding, RepObj.rAlignRight, verPadding + altoRenglon * renglon, RepObj.rAlignTop, new RepString(fPropNormal, TransformacionMyers.fnFormatoCurrency(descuento)));
                    renglon++;
                }
                foreach (ImpuestoMyers i in impuestos)
                {
                    if (i.Nombre != "IEPS")
                    {
                        Pie.AddAligned(horPadding + posPanelTotales, RepObj.rAlignLeft, verPadding + altoRenglon * renglon, RepObj.rAlignTop, new RepString(fPropNormal, i.Nombre + " " + TransformacionMyers.fnFormatoPorcentaje(i.Tasa)));
                        Pie.AddAligned(Pie.rWidth - horPadding, RepObj.rAlignRight, verPadding + altoRenglon * renglon, RepObj.rAlignTop, new RepString(fPropNormal, TransformacionMyers.fnFormatoCurrency(i.Importe)));
                        renglon++;
                    }
                }
                ...
                try
                {
                    ...
                    foreach (ImpuestoCompMyers i in impuestosComp)
                    {
                        Pie.AddAligned(horPadding + posPanelTotales, RepObj.rAlignLeft, verPadding + altoRenglon * renglon, RepObj.rAlignTop, new RepString(fPropNormal, i.Nombre + " " + TransformacionMyers.fnFormatoPorcentaje(i.Tasa)));
                        Pie.AddAligned(Pie.rWidth - horPadding, RepObj.rAlignRight, verPadding + altoRenglon * renglon, RepObj.rAlignTop, new RepString(fPropNormal, TransformacionMyers.fnFormatoCurrency(i.Importe)));
                        renglon++;
                ...
                Pie.AddAligned(Pie.rWidth - horPadding, RepObj.rAlignRight, tamCodigo - altoRenglon, RepObj.rAlignTop, new RepString(fPropNormal, TransformacionMyers.fnFormatoCurrency(total)));
            }
            ...
            if (nNumPag == nTotPag)//Si es ultima pagina
            {
                ...
                fnAgregarMultilinea(Pie, fnTextoImporte(TransformacionMyers.fnFormatoRedondeo(total), moneda), fPropChica, tamCodigo + horPadding, altoRenglon * 1.7, 80, true);
            ...
            if (nNumPag == nTotPag)//Si es ultima pagina
            {
                ...
                renglon = fnAgregarMultilinea(Pie, TransformacionMyers.fnConstruirCadenaTimbrado(gxComprobante.CreateNavigator().SelectSingleNode("/cfdi:Comprobante/cfdi:Complemento/tfd:TimbreFiscalDigital", nsmComprobante).CreateNavigator(), "cadenaoriginal_3_2")
            ...
            //fPropNormal = new FontProp(fuenteNormal, 4);
            //Pie.AddAligned(Pie.rWidth / 8.5, RepObj.rAlignCenter, Pie.rHeight / 3, RepObj.rAlignBottom, new RepString(fPropNormal, Settings.Default.urlHostComercial));
        ...
        private void fnDibujarTitulosDetalle(StaticContainer Encabezado, System.Drawing.Color sColor)
        {
            ...
            double posColumna1 = Encabezado.rWidth * 0.02;     //descripcion
            double posColumna2 = Encabezado.rWidth * 0.35;      //clave
            double posColumna3 = Encabezado.rWidth * 0.5;     //unidad
            ...
            Encabezado.AddAligned(posColumna1, RepObj.rAlignLeft, puntoMedio, RepObj.rAlignCenter, new RepString(fPropBlanca, "DESCRIPCIÓN"));
            Encabezado.AddAligned(posColumna2, RepObj.rAlignLeft, puntoMedio, RepObj.rAlignCenter, new RepString(fPropBlanca, "CLAVE"));
            Encabezado.AddAligned(posColumna3, RepObj.rAlignLeft, puntoMedio, RepObj.rAlignCenter, new RepString(fPropBlanca, "UNIDAD DE MEDIDA"));
        ...
        private void fnDatosEmisor(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, StaticContainer Encabezado, System.Drawing.Color sColor, ref double Renglon)
        {
            ...
            //double Renglon = 0;
            double i = 0;
            i = fnAgregarMultilinea(Encabezado, razonSocial, fPropTitulo, leftPadding + 210, posRenglon, 40, true);
            Renglon += i;
            if (i > 1)
                Renglon -= 0.5;
            if (exCalle != string.Empty)
            {
                i = fnAgregarMultilinea(Encabezado, rfc, fPropNormal, leftPadding + 210, posRenglon + tamRenglon * Renglon, 46, true);
                Renglon += i;
                if (i > 1)
                    Renglon -= 0.5;
                i = fnAgregarMultilinea(Encabezado, "EXPEDIDO EN", fPropNormal, leftPadding + 210, posRenglon + tamRenglon * Renglon, 46, true);
                Renglon += i;
                if (i > 1)
                    Renglon -= 0.5;
                i = fnAgregarMultilinea(Encabezado, exDireccion, fPropNormal, leftPadding + 210, posRenglon + tamRenglon * Renglon, 46, true);
                Renglon += i;
                if (i > 1)
                    Renglon -= 0.5;
                i = fnAgregarMultilinea(Encabezado, exUbicacion, fPropNormal, leftPadding + 210, posRenglon + tamRenglon * Renglon, 46, true);
                Renglon += i;
                if (i > 1)
                    Renglon -= 0.5;
                i = fnAgregarMultilinea(Encabezado, exUbicacion2, fPropNormal, leftPadding + 210, posRenglon + tamRenglon * Renglon, 46, true);
                Renglon += i;
                if (i > 1)
                    Renglon -= 0.5;
            ...
            {
                i = fnAgregarMultilinea(Encabezado, direccion, fPropNormal, leftPadding + 210, posRenglon + tamRenglon * Renglon, 46, true);
                Renglon += i;
                if (i > 1)
                    Renglon -= 0.5;

                i = fnAgregarMultilinea(Encabezado, ubicacion, fPropNormal, leftPadding + 210, posRenglon + tamRenglon * Renglon, 46, true);
                Renglon += i;
                if (i > 1)
                    Renglon -= 0.5;
                i = fnAgregarMultilinea(Encabezado, ubicacion2, fPropNormal, leftPadding + 210, posRenglon + tamRenglon * Renglon, 46, true);
                Renglon += i;
                if (i > 1)
                    Renglon -= 0.5;
                i = fnAgregarMultilinea(Encabezado, rfc, fPropNormal, leftPadding + 210, posRenglon + tamRenglon * Renglon, 46, true);
            ...
            if (!string.IsNullOrEmpty(referencia))
            {
                ...
                i = fnAgregarMultilinea(Encabezado, Refer, fPropNormal, leftPadding + 210, posRenglon + tamRenglon * Renglon, 46, true);
                Renglon += i;
                if (i > 1)
                    Renglon -= 0.5;
                if (version == "3.2")
                {
                    ...
                    i = fnAgregarMultilinea(Encabezado, sRegFis, fPropNormal, leftPadding + 210, posRenglon + tamRenglon * Renglon, 46, true);
                    Renglon += i;
                    if (i > 1)
                        Renglon -= 0.5;
                    i = fnAgregarMultilinea(Encabezado, Regimenfiscal, fPropNormal, leftPadding + 210, posRenglon + tamRenglon * Renglon, 46, true);
                    Renglon += i;
                    if (i > 1)
                        Renglon -= 0.5;
                }
            ...
            fnCrearPanelRedondeado(Encabezado, Encabezado.rWidth * .02, 0, fAnchoPanel + 75, fAltoPanel, grosorPen, radioCurva, false, sColor);
            fnCrearPanelRedondeado(Encabezado, Encabezado.rWidth * .02, fAltoPanel, fAnchoPanel + 75, fAltoPanel, grosorPen, radioCurva, false, sColor);
            ...
            try { informacion = navEncabezado.SelectSingleNode("/cfdi:Comprobante/Addenda/Correos/Informacion/@Mensaje", nsmComprobante).Value; }
            catch { }

            posX = leftPadding + 180;
            //posX = 20;
            //Folio Fiscal
            ...
            {
                Encabezado.AddAligned(posX, RepObj.rAlignRight,
                        fAltoPanel * 2 + 91, RepObj.rAlignTop,
                    new RepString(fPropNegrita, "Mensaje:"));
                Encabezado.AddAligned(posX, RepObj.rAlignRight,
                        fAltoPanel * 2 + 100, RepObj.rAlignTop,
                    new RepString(fPropNormal, informacion));
            }
        ...
        private void fnDatosReceptor(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, StaticContainer Encabezado, double Renglon)
        {
            ...
            double leftPadding = Encabezado.rWidth * 0.02;
            double sep = 5;//10
            double posRazon = 8 + sep; //(Encabezado.rHeight + 20) / 2 + fPropTitulo.rSize;
            double tamRenglon = fPropNormal.rSize + sep;
            double posRenglon = posRazon + sep;
            fPropNormal.rSize = 5;
            ...
            Renglon += 0.5;
            double i = 0;
            i = fnAgregarMultilinea(Encabezado, razonSocial, fPropTitulo, leftPadding + 360, posRenglon, 76, true);
            Renglon += i;
            if (i > 1)
                Renglon -= 1.5;
            else
            ...
            i = fnAgregarMultilinea(Encabezado, direccion, fPropNormal, leftPadding + 360, posRenglon + tamRenglon, 90, true);
            Renglon += i;
            if (i > 1)
                Renglon -= 0.5;
            ...
            {
                i = fnAgregarMultilinea(Encabezado, ubicacion, fPropNormal, leftPadding + 360, posRenglon + tamRenglon * Renglon, 90, true);
                Renglon += i;
                if (i > 1)
                    Renglon -= 0.5;
            }
            ...
            {
                i = fnAgregarMultilinea(Encabezado, rfc, fPropNormal, leftPadding + 360, posRenglon + tamRenglon * Renglon, 90, true);
                Renglon += i;
                if (i > 1)
                    Renglon -= 0.5;
            }
        ...
        public void fnCrearPanelRedondeado(StaticContainer poObjeto, double pfPosX, double pfPosY, double pfAncho, double pfAlto, double pfGrosor, double pfRadioCurva, bool pbRellenar, System.Drawing.Color sColor)
        {
            ...
            if (pbRellenar)
            {
                ...
                poObjeto.Add(pfPosX, pfPosY, new RepRect(pen, brush, pfAncho, lArc - pfAlto));
                poObjeto.Add(pfPosX, pfPosY, new RepRect(pen, brush, pfAncho, -pfAlto));
            ...
            else
            {
                ...
                //borde superior
                poObjeto.Add(pfPosX, pfPosY + pfRadioCurva, new RepLine(pen, pfAncho, 0));
                //poObjeto.Add(pfPosX + pfRadioCurva, pfPosY, new RepLine(pen, pfAncho - lArc, 0));

                //borde inferior
                poObjeto.Add(pfPosX, pfPosY + pfAlto, new RepLine(pen, pfAncho, 0));

                ////borde izquierdo
                poObjeto.Add(pfPosX, pfPosY + pfRadioCurva, new RepLine(pen, 0, lArc - (pfAlto + pfRadioCurva)));

                ////borde derecho
                poObjeto.Add(pfPosX + pfAncho, pfPosY + pfRadioCurva, new RepLine(pen, 0, lArc - (pfAlto + pfRadioCurva)));
            }
        }
        ...
        private void fnAgregarBordeRedondeado(StaticContainer poObjeto, double pfGrosor, double pfRadioCurva, System.Drawing.Color sColor)
        {
            ...
            //añadimos los bordes rectos
            //borde superior
            poObjeto.Add(0, 0, new RepLine(pen, poObjeto.rWidth, 0));

            //borde inferior
            poObjeto.Add(0, poObjeto.rHeight, new RepLine(pen, poObjeto.rWidth, 0));

            ////borde izquierdo
            poObjeto.Add(0, 0, new RepLine(pen, 0, -poObjeto.rHeight));

            ////borde derecho
            poObjeto.Add(poObjeto.rWidth, 0, new RepLine(pen, 0, -poObjeto.rHeight));
        }
        ...
        private string fnTextoImporte(string psValor, string psMoneda)
        {
            ...
            NumaletMyers parser = new NumaletMyers();
            parser.LetraCapital = true;

            switch (psMoneda)
            {
                case "MXN":
                    parser.TipoMoneda = NumaletMyers.Moneda.Peso;
                    break;
                case "USD":
                    parser.TipoMoneda = NumaletMyers.Moneda.Dolar;
                    break;
                case "XEU":
                    parser.TipoMoneda = NumaletMyers.Moneda.Euro;
                    break;
            }
        ...
        private RepImage fnMarcaAguaCorpus()
        {
            ...
            {
                //clsErrorLogMyers.fnNuevaEntrada(ex, clsErrorLogMyers.TipoErroresLog.Referencia);
            }
        ...
        private RepImage fnImagenPAX()
        {
            ...
            try
            {
                string fichero = Settings.Default["imagenes"].ToString() + "logo_pax.jpg";
                Image image = Image.FromFile(fichero);
    ...
    public class ImpuestoMyers
    {
        ...
        public string TextoImpuesto
        {
            get
            {
                return Nombre + " " + TransformacionMyers.fnFormatoPorcentaje(Tasa) + " " + TransformacionMyers.fnFormatoCurrency(Importe);
            }
        }
        ...
        public ImpuestoMyers(XPathNavigator navImpuesto, XmlNamespaceManager nsmComprobante)
        {
    ...
    /// tanto para traslados como para retenciones
    /// </summary>
    public class ImpuestoCompMyers
    {
        public string Nombre { get; set; }
        public string Tasa { get; set; }
        public string Importe { get; set; }
        ...
        /// <param name="navPie">Navegador XML con los valores de los impuestos</param>
        /// <param name="nsmComprobante"></param>
        public ImpuestoCompMyers(XPathNavigator navImpuesto, XmlNamespaceManager nsmComprobante)
        {
            try
            {
    ...
    public class DetalleMyers
    {
        ...
        private List<ComprobanteImpuestosRetencionTMyers> _retencionesT;
        public List<ComprobanteImpuestosRetencionTMyers> RetencionesT
        {
            get { return _retencionesT; }
            set { _retencionesT = value; }
        }

        private List<ComprobanteImpuestosTrasladoTMyers> _trasladosT;
        public List<ComprobanteImpuestosTrasladoTMyers> TrasladosT
        {
            get { return _trasladosT; }
            set { _trasladosT = value; }
        }

        private t_UbicacionFiscalTMyers _ubicacionFiscalT;
        public t_UbicacionFiscalTMyers UbicacionFiscalT
        {
            get { return _ubicacionFiscalT; }
            set { _ubicacionFiscalT = value; }
        }

        private t_InformacionAduaneraTMyers _informacionAduaneraT;
        public t_InformacionAduaneraTMyers InformacionAduaneraT
        {
        ...
        /// <param name="nsmComprobante">Manejador de nombres de espacio</param>
        public DetalleMyers(XPathNavigator navDetalle, XmlNamespaceManager nsmComprobante)
        {
            try
            {
            ...
            try
            {
                List<ComprobanteImpuestosRetencionTMyers> impuestosRetencion = new List<ComprobanteImpuestosRetencionTMyers>();
                List<ComprobanteImpuestosTrasladoTMyers> impuestosTraslado = new List<ComprobanteImpuestosTrasladoTMyers>();
                ...
                {
                    ComprobanteImpuestosRetencionTMyers impRet = new ComprobanteImpuestosRetencionTMyers();
                    ...
                    try
                    {
                        ...
                        if (!String.IsNullOrEmpty(sImpuestoRet))
                        {
                            ...
                            {
                                case "IVA": impRet.impuesto = ComprobanteImpuestosRetencionImpuestoTMyers.IVA; break;
                                case "ISR": impRet.impuesto = ComprobanteImpuestosRetencionImpuestoTMyers.ISR; break;
                            }
                        }
                ...
                {
                    ComprobanteImpuestosTrasladoTMyers impTras = new ComprobanteImpuestosTrasladoTMyers();
                    ...
                    try
                    {
                        ...
                        if (!String.IsNullOrEmpty(sImpuestoTras))
                        {
                            ...
                            {
                                case "IVA": impTras.impuesto = ComprobanteImpuestosTrasladoImpuestoTMyers.IVA; break;
                                case "IEPS": impTras.impuesto = ComprobanteImpuestosTrasladoImpuestoTMyers.IEPS; break;
                            }
                        }
                ...
                try
                {
                    t_UbicacionFiscalTMyers ubicacionTerceros = new t_UbicacionFiscalTMyers();
                ...
                try
                {
                    t_InformacionAduaneraTMyers aduaneraTerceros = new t_InformacionAduaneraTMyers();
    ...
    public partial class ComprobanteImpuestosRetencionTMyers
    {
        private ComprobanteImpuestosRetencionImpuestoTMyers impuestoField;
        private decimal importeField;

        public ComprobanteImpuestosRetencionImpuestoTMyers impuesto
        {
    ...
    public enum ComprobanteImpuestosRetencionImpuestoTMyers
    {
        ISR, IVA,
    }

    public partial class ComprobanteImpuestosTrasladoTMyers
    {
        private ComprobanteImpuestosTrasladoImpuestoTMyers impuestoField;
        private decimal tasaField;
        private decimal importeField;

        public ComprobanteImpuestosTrasladoImpuestoTMyers impuesto
        {
            get { return this.impuestoField; }
            set { this.impuestoField = value; }
        }
    ...
    public enum ComprobanteImpuestosTrasladoImpuestoTMyers
    {
        IVA, IEPS,
    }

    public partial class t_UbicacionFiscalTMyers
    {
    ...
    public partial class t_InformacionAduaneraTMyers
    {
    ...
    /// </summary>
    public class TransformacionMyers
    {
        ...
        public static string fnConstruirCadenaTimbrado(IXPathNavigable xml, string psNombreArchivoXSLT)
        {
            ...
            try
            {
                ...
                //trans.Load(XmlTextReader.Create(new StringReader(Settings.Default[psNombreArchivoXSLT].ToString())));
                //trans.Load(mxl);
            ...
            {
                //clsErrorLogMyers.fnNuevaEntrada(ex, clsErrorLogMyers.TipoErroresLog.Datos);
            }
    ...
    public class clsComunMyers
    {
        ...
        public static InterfazSQL fnCrearConexion(string psNombreConexion)
        {
            ...
            {
                clsErrorLogMyers.fnNuevaEntrada(ex, clsErrorLogMyers.TipoErroresLog.Conexion);
                return null;
            }
        }
    ...
    public sealed class NumaletMyers
    {
        ...
        public NumaletMyers(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
        {
        ...
        {
            return NumaletMyers.ToString(Numero, CultureInfo.CurrentCulture);
        }
