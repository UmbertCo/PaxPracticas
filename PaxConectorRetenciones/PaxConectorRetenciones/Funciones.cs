...
//PARA AMPLIAR CONCEPTOS
        ...
        public Report fnGenerarPDF(Color pColor, XmlDocument gxComprobante)
        {
            ...
            while (bSeguir)
            {
                ...
                catch (Exception ex)
                {
                    ...
                    throw new Exception("No se encuentra el logo pax", ex);
                }
        ...
        private RepImage fnImagenEmpresa()
        {
            ...
            {
                Log("No se encontro un logo de la empresa: " + ex.Message.ToString());
            }
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            if (detalles.Count == 0)
            {
                ...
                string montoTotExentC = Convert.ToDouble(montoTotExent, languaje).ToString("c", languaje);
                ...
                string montoTotGravC = Convert.ToDouble(montoTotGrav, languaje).ToString("c", languaje);
                ...
                string montoTotRetC = Convert.ToDouble(montoTotRet, languaje).ToString("c", languaje);
                ...
                string montoTotOperacionC = Convert.ToDouble(montoTotOperacion, languaje).ToString("c", languaje);
...
// ARGUMENTOS OPCIONALES
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////
        ...
        private StaticContainer fnCrearPagosAExtranjeros(List<pagosAExtranjeros> pagos, System.Drawing.Color sColor, int pnPaginas, int pnPaginaActual, Report PDF, XmlDocument gxComprobante)
        {
            ...
            for (int i = 0; renglonActual <= maxRenglones; i++)
            {
                ...
                if (i == 0)
                {
                    ...
                    areaDetalle.AddAligned(posColumna5 - RT.rPointFromMM(15), RepObj.rAlignLeft, posRenglon - RT.rPointFromMM(5), RepObj.rAlignBottom, new RepString(fPropNegrita, "Tipo de Contribuyente"));
        ...
        private StaticContainer fnCrearPremios(List<premios> premios, System.Drawing.Color sColor, int pnPaginas, int pnPaginaActual, Report PDF, XmlDocument gxComprobante)
        {
            ...
            double posColumna1 = areaDetalle.rWidth * 0.1;
            double posColumna2 = areaDetalle.rWidth * 0.35;
            double posColumna3 = areaDetalle.rWidth * 0.58; //0.2;
            double posColumna4 = areaDetalle.rWidth * 0.86; //0.2;
            ...
            for (int i = 0; renglonActual <= maxRenglones; i++)
            {
                ...
                if (i == 0)
                {
                    ...
                    fnAgregarMultilinea(areaDetalle, "Clave Entidad Federativa", fPropNegrita, posColumna1 - RT.rPointFromMM(17), posRenglon - RT.rPointFromMM(5), 40, true);
                    fnAgregarMultilinea(areaDetalle, "Importe de Premio", fPropNegrita, posColumna2 - RT.rPointFromMM(7), posRenglon - RT.rPointFromMM(5), 40, true);
                    fnAgregarMultilinea(areaDetalle, "Importe Gravado", fPropNegrita, posColumna3 - RT.rPointFromMM(8), posRenglon - RT.rPointFromMM(5), 40, true);
                    areaDetalle.AddAligned(posColumna4 - RT.rPointFromMM(7), RepObj.rAlignLeft, posRenglon - RT.rPointFromMM(5), RepObj.rAlignBottom, new RepString(fPropNegrita, "Importe Exento"));
                }
                //////////////////////////////////////////////////////////////////////////////////////////////CAMBIAR//////////////////////////////////////////////////////////////////
               ...
               /* if (i == 0)
                {
                    ...
                    fnAgregarMultilinea(areaDetalle, "Clave Entidad Federativa:", fPropNegrita, posColumna1, posRenglon, 40, true);
        ...
        private StaticContainer fnCrearPlanesDeRetiro(List<planesDeRetiro> planes, System.Drawing.Color sColor, int pnPaginas, int pnPaginaActual, Report PDF, XmlDocument gxComprobante)
        {
            ...
            double posColumna1 = areaDetalle.rWidth * 0.09;
            double posColumna2 = areaDetalle.rWidth * 0.32;
            double posColumna3 = areaDetalle.rWidth * 0.58; //0.2;
            double posColumna4 = areaDetalle.rWidth * 0.86; //0.2;
            ...
            for (int i = 0; renglonActual <= maxRenglones; i++)
            {
                ...
                if (i == 0)
                {
                    ...
                    fnAgregarMultilinea(areaDetalle, "Sistema Financiero:", fPropNegrita, posColumna1 - RT.rPointFromMM(12), posRenglon - RT.rPointFromMM(5), 40, true);
                    fnAgregarMultilinea(areaDetalle, "Monto Interés Real:", fPropNegrita, posColumna2 - RT.rPointFromMM(9), posRenglon - RT.rPointFromMM(5), 40, true);
                    fnAgregarMultilinea(areaDetalle, "Retiro de Recursos:", fPropNegrita, posColumna3 - RT.rPointFromMM(11), posRenglon - RT.rPointFromMM(5), 40, true);
                    areaDetalle.AddAligned((posColumna4 - RT.rPointFromMM(18)), RepObj.rAlignLeft, posRenglon - RT.rPointFromMM(5), RepObj.rAlignBottom, new RepString(fPropNegrita, "Retiros en el Ejercicio Anterior:"));
                }
                //////////////////////////////////////////////////////////////////////////////////////////////CAMBIAR//////////////////////////////////////////////////////////////////
                Col1 = fnAgregarMultilinea(areaDetalle, d.SistemaFinanc, fPropChica, posColumna1, posRenglon, 20, true);
                Col2 = fnAgregarMultilinea(areaDetalle, d.MontIntRealesDevengAniooInmAnt, fPropChica, posColumna2, posRenglon, 40, true);
                Col3 = fnAgregarMultilinea(areaDetalle, d.HuboRetirosAnioInmAntPer, fPropChica, posColumna3, posRenglon, 40, true);
                areaDetalle.AddAligned(posColumna4, RepObj.rAlignLeft, posRenglon, RepObj.rAlignBottom, new RepString(fPropChica, d.HuboRetirosAnioInmAnt));
