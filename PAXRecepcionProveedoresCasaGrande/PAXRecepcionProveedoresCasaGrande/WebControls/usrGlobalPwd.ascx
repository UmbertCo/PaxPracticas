                    ...
                    <table align="center">
                        <tr>
                            <td align="left"><asp:Label ID="lblContraseniaAnterior" runat="server" 
                                    ...
                                    Style="font-family: 'Century Gothic'" ForeColor="White"></asp:Label>  </td>
                        </tr>
                            <tr>
                             ...
                             ValidationGroup="ChangeUserPasswordValidationGroup" Width="20px">*</asp:RequiredFieldValidator></td>
                                ...
                                <tr>
                                    <td align="left"><asp:Label ID="lblContraseniaNueva" runat="server" 
                                            ...
                                            Text="<%$ Resources:resCorpusCFDIEs, lblContraseniaNueva %>" Style="font-family: 'Century Gothic'" ForeColor="White"></asp:Label></td>
                                </tr>
                                <tr>
                            ...
                            AssociatedControlID="txtConfirmaNueva"  
                                                Text="<%$ Resources:resCorpusCFDIEs, lblConfirmaNueva %>" Style="font-family: 'Century Gothic'" ForeColor="White"></asp:Label></td>
                                    </tr>
                                    <tr>
