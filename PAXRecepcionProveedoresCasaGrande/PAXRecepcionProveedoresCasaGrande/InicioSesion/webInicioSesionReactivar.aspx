<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="webInicioSesionReactivar.aspx.cs" Inherits="InicioSesion_webInicioSesionReactivar" %>
                ...
                <tr>
                    <td align="left">
                        <asp:Label ID="lblUsuario" runat="server" AssociatedControlID="txtUsuario" 
                            Text="<%$ Resources:resCorpusCFDIEs, lblUsuario %>" Style="font-family: 'Century Gothic'" ForeColor="White"></asp:Label>
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
