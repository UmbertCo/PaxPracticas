<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="webInicioSesionRecupera.aspx.cs" Inherits="InicioSesion_webInicioSesionRecupera" %>
    ...
    <div class="accountInfo">
        <asp:Panel ID="pnlDatos" runat="server" BackImageUrl="~/Imagenes/login.png"  
            ...
            <table>
                ...
                <tr>
                    <td align="left">
                        <asp:Label ID="lblUsuario" runat="server" AssociatedControlID="txtUsuario" Style="font-family: 'Century Gothic'" ForeColor="White"
                ...
                <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" 
                            ...
                            ValidationGroup="RegisterUserValidationGroup" Height="18px">
                ...
                <tr>
                    <td align="left">
                        <asp:Label ID="lblCorreo" runat="server" AssociatedControlID="txtCorreo" 
                            Text="<%$ Resources:resCorpusCFDIEs, lblCorreo %>" Style="font-family: 'Century Gothic'" ForeColor="White"></asp:Label> 
                    </td>
                    <td>
                        &nbsp;</td>
                </tr>
                ...
                src="../Imagenes/error_sign.gif" /></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                            ...
                            ValidationGroup="RegisterUserValidationGroup" Width="19px"><img 
