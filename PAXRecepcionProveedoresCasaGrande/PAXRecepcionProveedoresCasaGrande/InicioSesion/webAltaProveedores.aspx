<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="webAltaProveedores.aspx.cs" Inherits="InicioSesion_webAltaProveedores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:UpdatePanel ID="upAltaProveedor" runat="server">
        <ContentTemplate>
        <table style="border: 2px ridge #8B181B; width: 852px; width=100%; height=100%" class="bodyMain">
            <tr>
                <td align="left">
                *<asp:Label ID="lblNombre" runat="server" 
                ...
                <td>*<asp:Label ID="lblContacto" runat="server" 
                                    ...
                                    Text="<%$ Resources:resCorpusCFDIEs, lblContacto %>"></asp:Label></td>
            </tr>
                <tr>
                    <td align="left">
                    ...
                    <td> <asp:TextBox ID="txtContacto" runat="server" Width="220px" TabIndex="2"></asp:TextBox> 
                        ...
                        <td align="left"><asp:Label ID="lblEstado" runat="server" AssociatedControlID="ddlEstado" 
                            ...
                            <td align="left"> <asp:Label ID="lblLocalidad" runat="server" AssociatedControlID="txtLocalidad" 
                                ...
                                Text="<%$ Resources:resCorpusCFDIEs, lblCalle %>"></asp:Label></td>
                                    ...
                                    <td></td>
                                    <td align="left"><asp:TextBox ID="txtCalle" runat="server" TabIndex="8" Width="220px"></asp:TextBox> <asp:RequiredFieldValidator ID="rfvCalle" runat="server" 
                                ...
                                Text="<%$ Resources:resCorpusCFDIEs, lblCodigoPostal %>"></asp:Label></td>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td align="left"><asp:TextBox ID="txtCodigoPostal" runat="server" TabIndex="11" Width="220px"></asp:TextBox>
                                    ...
                                    <img src="../Imagenes/error_sign.gif" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left">*<asp:Label ID="lblTelefono" runat="server" AssociatedControlID="txtTelefono" 
                                                                        Text="<%$ Resources:resCorpusCFDIEs, lblTelefono %>" /></td>
                                                </tr>
                                                    <tr>
                                                    <td align="left"><asp:TextBox ID="txtNoInterior" runat="server" TabIndex="10" Width="220px"></asp:TextBox></td>
                                                    <td></td>
                                                    <td align="left"> <asp:TextBox ID="txtTelefono" runat="server" TabIndex="13" Width="220px"></asp:TextBox>
                                        ...
                                        Text="<%$ Resources:resCorpusCFDIEs, lblRecibiraCorreo %>" ForeColor="#8B181B" Font-Bold="True"/> </td>
                                                                    ...
                                                                    <td>  </td>
                                                                         <td></td>
                                                                                ...
                                                                                ToolTip="<%$ Resources:resCorpusCFDIEs, lblUsuarioRequerido %>" ValidationGroup="RegisterUserValidationGroup">
                                                                                <img src="../Imagenes/error_sign.gif" /></asp:RequiredFieldValidator>
                                                                                <asp:RegularExpressionValidator ID="RegxNombre" runat="server" ControlToValidate="txtUsuario"
