<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="webOperacionUsuarios.aspx.cs" Inherits="Operacion_Usuarios_webOperacionUsuarios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <br /><br /><br />
    ...
    <br />
    <div class="bodyMainComprobantes">
    <table width="100%"; height="100%" style="border: 2px ridge #9C1518">
        <tr>
            <td>
                <asp:UpdatePanel ID="udpEstructura" runat="server">
        <ContentTemplate>
            <fieldset class="register" style="width: 890px; height: 380px; border:none">
                <%--<legend>
    ...
    <asp:UpdatePanel ID="upFormulario" runat="server">
        <ContentTemplate>
            <asp:Panel ID="pnlFormulario" runat="server" Height="528px">
                    ...
                    <fieldset class="register" style="height: 350px; width: 890px; border:none">
                        <legend>
                            <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:resCorpusCFDIEs, lblDatosUsuario %>" /></legend>
                        <table>
                            <tr>
                                <td valign="top" align="left" style="vertical-align: top; width: 400px;">
