...
public class clsInicioSesionSolicitudReg
{
    ...
    /// Encargado de recuperar la lista de modulos del usuario.
    /// </summary>
    /// <param name="sUsuario">Id del usuario</param>
    /// <returns>Modulos correspondientes al usuario</returns>
    public DataTable fnRecuperaModulosUsuario(int nIdUsuario)
    {
        ...
        try
        {
            ...
            conexion.AgregarParametro("sClaveUsuario", nIdUsuario);
