...
public class clsPlantillaLogo
{
    ...
    /// </summary>
	public void fnGenerarPDF(int nIdComprobante,string scolor)
	{
        TipoDocumento = "Factura";
    ...
    public void fnGenerarPDFSave(int nIdComprobante,string scolor,string ruta)
    {
        TipoDocumento = "Factura";
        Formatter formato = new PdfFormatter();
        PDF = new Report(formato);
...
public class TransformacionLogo
{
    ...
    public static string fnConstruirCadenaTimbrado(IXPathNavigable xml, string psNombreArchivoXSLT)
    {
        ...
        try
        {
            ...
            string xslt = clsComunLogo.ObtenerParamentro(psNombreArchivoXSLT);
            trans.Load(XmlReader.Create(new StringReader(xslt)));
