...
/// 
    public class clsOperacionConsulta
    {
        ...
        public DataTable fnObtenerComprobantes(string psRfc, string psEstatus, string psIdSucursal,
                                                ...
                                                string psFolioFin, DateTime pdFechaIni, DateTime pdFechaFin, string sUUID, int pPagina, string psIdUsuario_Filtro)
        {
                                                ...
                                                string psFolioFin, DateTime pdFechaIni, DateTime pdFechaFin, string sUUID)
        {
            ...
            using (SqlConnection conexion = new SqlConnection(Utilerias.Encriptacion.Base64.DesencriptarBase64(cadena)))
            {
                conexion.Open();
        ...
        public DataTable fnObtenerUsuarios(int pnIdUsuario)
        {
            ...
            try
            {
                ...
                giSql.Query("usp_Con_Recupera_Usuarios_Consulta_Sel", true, ref dtAuxiliar);
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Trae la lista de correos del cliente.
        /// <param name="nId_Estructura">Id de Estrucutura</param>
        /// <param name="psRfc">Parametro Opcional RFC</param>
        /// <param name="psRazonSocial">Parametro Opcional Razon Social</param>
        /// </summary>
        public DataTable fnLlenarGridCorreos(string nId_Estructura, string psRfc, string psRazonSocial)
        {
            DataTable dtAuxiliar = new DataTable();
