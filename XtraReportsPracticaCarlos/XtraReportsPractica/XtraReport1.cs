...
namespace XtraReportsPractica
{
    public partial class XtraReport1 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void xrLabelConLetra_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            XRLabel CeldaTotal = (XRLabel)sender;
            if (CeldaTotal.Text != "")
            {
                (sender as XRLabel).Text = fnTextoImporte(CeldaTotal.Text, "MXN").ToUpper();
            }
        }
        ...
        private void xrTableCellTipoRegimen_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
        ...
        private void xrTableCellBanco_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
