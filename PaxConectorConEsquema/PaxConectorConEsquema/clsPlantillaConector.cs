...
public class clsPlantillaConector
{
    #region atributos
    ...
    private const double radioCurva = .01;
    ...
    public clsPlantillaConector(XmlDocument pxComprobante)
    {
    ...
    /// Update:Acutalizacion en pdf 
    /// **************************************************************************
    /// ESte es solamente un comentario para práctica con tream foundation
    /// No tienen importancia estas lineas en el proyecto
    /// por lo tanto no es necesario quitarlas
    /// ni modificarlas, así deben quedarse
    /// **************************************************************************
    /// </summary>
    string sVariableSinImportancia = string.Empty;
    ...
    public void fnGenerarPDFSave(string ruta, string scolor)
    {
        ...
        while (bSeguir)
        {
            ...
            {
                RepImage image = new RepImage(ms, 150, 41);
                pagina.Add(Encabezado.rWidth - image.rWidth, margenPagina + 60, image);
                  //RepImage image = new RepImage(ms, 150, 41);
                  //pagina.Add(margenPagina + 12, margenPagina + 60, image);
            }
    ...
    private void fnTotales(XmlNamespaceManager nsmComprobante, XPathNavigator navPie, StaticContainer Pie, int nNumPag, int nTotPag, string sColor)
    {
        ...
        RepString rLiga = new RepString(fPropNormal, Settings.Default.urlHostComercial);
        rLiga.RotateTransform(270);
        Pie.AddAligned(Pie.rWidth - Pie.rWidth - 10, RepObj.rAlignCenter, Pie.rHeight - 50 , RepObj.rAlignTop, rLiga);
        
        //Agrega leyenda de comprobante
        fPropNormal = new FontProp(fuenteNormal, tamFuenteNormal);
        RepString rEsteDocumento = new RepString(fPropNormal, leyendaPDF);
        rEsteDocumento.RotateTransform(270);
        Pie.AddAligned(Pie.rWidth + 5, RepObj.rAlignCenter, altoPagina - altoPagina *2, RepObj.rAlignTop, rEsteDocumento);
    }
    ...
    private void fnDatosEmisor(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, StaticContainer Encabezado, System.Drawing.Color sColor, ref double Renglon)
    {
        ...
        double leftPadding = Encabezado.rWidth * 0.07;
        double sep = 5; //10
      ...
      //  //fnCrearPanelRedondeado(Encabezado, posX, 0, fAnchoPanel, fAltoPanel, grosorPen, radioCurva, true);
        ...
        fnCrearPanelRedondeado(Encabezado, 0, 0, fAnchoPanel + 75, fAltoPanel, grosorPen, radioCurva, false, sColor);
        fnCrearPanelRedondeado(Encabezado, 0, fAltoPanel, fAnchoPanel + 75, fAltoPanel, grosorPen, radioCurva, false, sColor);
       ...
       // posX = Encabezado.rWidth - leftPadding;
        ...
        {
            Encabezado.AddAligned(posX + fAnchoPanel, RepObj.rAlignRight,
    ...
    private void fnDatosReceptor(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, StaticContainer Encabezado, double Renglon)
    {
        ...
        double posRenglon = posRazon + sep;
        fPropNormal.rSize = 5;
        double leftPadding = Encabezado.rWidth - Encabezado.rWidth / 3;
        ...
        //Encabezado.AddAligned(leftPadding + leftPadding, RepObj.rAlignRight, posRenglon + tamRenglon * Renglon++, RepObj.rAlignTop, new RepString(fPropTitulo, razonSocial));
