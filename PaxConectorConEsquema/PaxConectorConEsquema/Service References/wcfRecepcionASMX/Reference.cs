...
namespace PaxConectorConEsquema.wcfRecepcionASMX {
    ...
    public interface wcfRecepcionASMXSoap {
        ...
        PaxConectorConEsquema.wcfRecepcionASMX.fnEnviarXMLResponse fnEnviarXML(PaxConectorConEsquema.wcfRecepcionASMX.fnEnviarXMLRequest request);
    }
    ...
    public partial class fnEnviarXMLRequest {
        ...
        public PaxConectorConEsquema.wcfRecepcionASMX.fnEnviarXMLRequestBody Body;
        
        public fnEnviarXMLRequest() {
        }
        
        public fnEnviarXMLRequest(PaxConectorConEsquema.wcfRecepcionASMX.fnEnviarXMLRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class fnEnviarXMLResponse {
        ...
        public PaxConectorConEsquema.wcfRecepcionASMX.fnEnviarXMLResponseBody Body;
        
        public fnEnviarXMLResponse() {
        }
        
        public fnEnviarXMLResponse(PaxConectorConEsquema.wcfRecepcionASMX.fnEnviarXMLResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface wcfRecepcionASMXSoapChannel : PaxConectorConEsquema.wcfRecepcionASMX.wcfRecepcionASMXSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class wcfRecepcionASMXSoapClient : System.ServiceModel.ClientBase<PaxConectorConEsquema.wcfRecepcionASMX.wcfRecepcionASMXSoap>, PaxConectorConEsquema.wcfRecepcionASMX.wcfRecepcionASMXSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        PaxConectorConEsquema.wcfRecepcionASMX.fnEnviarXMLResponse PaxConectorConEsquema.wcfRecepcionASMX.wcfRecepcionASMXSoap.fnEnviarXML(PaxConectorConEsquema.wcfRecepcionASMX.fnEnviarXMLRequest request) {
        ...
        public string fnEnviarXML(string psComprobante, string psTipoDocumento, int pnId_Estructura, string sNombre, string sContraseña, string sVersion) {
            PaxConectorConEsquema.wcfRecepcionASMX.fnEnviarXMLRequest inValue = new PaxConectorConEsquema.wcfRecepcionASMX.fnEnviarXMLRequest();
            inValue.Body = new PaxConectorConEsquema.wcfRecepcionASMX.fnEnviarXMLRequestBody();
            ...
            PaxConectorConEsquema.wcfRecepcionASMX.fnEnviarXMLResponse retVal = ((PaxConectorConEsquema.wcfRecepcionASMX.wcfRecepcionASMXSoap)(this)).fnEnviarXML(inValue);
