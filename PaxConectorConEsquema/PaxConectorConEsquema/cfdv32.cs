...
namespace cfdv32 {
   ...
   // [System.Diagnostics.DebuggerStepThroughAttribute()]
    ...
    public partial class Comprobante {
        ...
        public Comprobante(string[] elementos) 
        {
            foreach (string arreglo in elementos)
            {
                 if(elementos[0].Contains("serie"))
                 {
                     this.serie = elementos[1];
                     break;
                 }

                 if (elementos[0].Contains("folio"))
                 {
                     this.folio = elementos[1];
                     break;
                 }

                 if (elementos[0].Contains("fecha"))
                 {
                     this.fecha = DateTime.Parse(elementos[1]);
                     break;
                 }

                 if (elementos[0].Contains("sello"))
                 {
                     this.sello = elementos[1];
                     break;
                 }

                 if (elementos[0].Contains("formaDePago"))
                 {
                     this.formaDePago = elementos[1];
                     break;
                 }

                 if (elementos[0].Contains("noCertificado"))
                 {
                     this.noCertificadoField = elementos[1];
                     break;
                 }

                 if (elementos[0].Contains("certificado"))
                 {
                     this.certificado = elementos[1];
                     break;
                 }

                 if (elementos[0].Contains("subTotal"))
                 {
                     this.subTotalField = decimal.Parse(elementos[1]);
                     break;
                 }

                 if (elementos[0].Contains("Moneda"))
                 {
                     this.monedaField = elementos[1];
                     break;
                 }

                 if (elementos[0].Contains("total"))
                 {
                     this.totalField = decimal.Parse(elementos[1]);
                     break;                 
                 }

                 if (elementos[0].Contains("tipoDeComprobante"))
                 {
                     if(elementos[1].Contains("ingreso"))
                     {
                         this.tipoDeComprobanteField = ComprobanteTipoDeComprobante.ingreso;
                         break;
     
                     }
                     else if (elementos[1].Contains("egreso"))
                     {
                         this.tipoDeComprobanteField = ComprobanteTipoDeComprobante.egreso;
                         break;

                     }
                     else if (elementos[1].Contains("traslado"))
                     {
                         this.tipoDeComprobanteField = ComprobanteTipoDeComprobante.traslado;
                         break;

                     }
                 }

                 if (elementos[0].Contains("lugarExpedicion"))
                 {
                     this.lugarExpedicionField = elementos[1];
                     break;
                 }

                 if (elementos[0].Contains("metodoDePago"))
                 {
                     this.metodoDePagoField = elementos[1];
                     break;
                 }
            }
        }
