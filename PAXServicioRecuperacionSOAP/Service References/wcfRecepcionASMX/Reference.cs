...
namespace PAXServicioRecuperacionSOAP.wcfRecepcionASMX
{
    ...
    public interface wcfRecepcionASMXSoap {
        ...
        PAXServicioRecuperacionSOAP.wcfRecepcionASMX.fnEnviarXMLResponse fnEnviarXML(PAXServicioRecuperacionSOAP.wcfRecepcionASMX.fnEnviarXMLRequest request);
    }
    ...
    public partial class fnEnviarXMLRequest {
        ...
        public PAXServicioRecuperacionSOAP.wcfRecepcionASMX.fnEnviarXMLRequestBody Body;
        
        public fnEnviarXMLRequest() {
        }

        public fnEnviarXMLRequest(PAXServicioRecuperacionSOAP.wcfRecepcionASMX.fnEnviarXMLRequestBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    public partial class fnEnviarXMLResponse {
        ...
        public PAXServicioRecuperacionSOAP.wcfRecepcionASMX.fnEnviarXMLResponseBody Body;
        
        public fnEnviarXMLResponse() {
        }

        public fnEnviarXMLResponse(PAXServicioRecuperacionSOAP.wcfRecepcionASMX.fnEnviarXMLResponseBody Body)
        {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface wcfRecepcionASMXSoapChannel : PAXServicioRecuperacionSOAP.wcfRecepcionASMX.wcfRecepcionASMXSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class wcfRecepcionASMXSoapClient : System.ServiceModel.ClientBase<PAXServicioRecuperacionSOAP.wcfRecepcionASMX.wcfRecepcionASMXSoap>, PAXServicioRecuperacionSOAP.wcfRecepcionASMX.wcfRecepcionASMXSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        PAXServicioRecuperacionSOAP.wcfRecepcionASMX.fnEnviarXMLResponse PAXServicioRecuperacionSOAP.wcfRecepcionASMX.wcfRecepcionASMXSoap.fnEnviarXML(PAXServicioRecuperacionSOAP.wcfRecepcionASMX.fnEnviarXMLRequest request) {
        ...
        public string fnEnviarXML(string psComprobante, string psTipoDocumento, int pnId_Estructura, string sNombre, string sContraseña, string sVersion) {
            PAXServicioRecuperacionSOAP.wcfRecepcionASMX.fnEnviarXMLRequest inValue = new PAXServicioRecuperacionSOAP.wcfRecepcionASMX.fnEnviarXMLRequest();
            inValue.Body = new PAXServicioRecuperacionSOAP.wcfRecepcionASMX.fnEnviarXMLRequestBody();
            ...
            PAXServicioRecuperacionSOAP.wcfRecepcionASMX.fnEnviarXMLResponse retVal = ((PAXServicioRecuperacionSOAP.wcfRecepcionASMX.wcfRecepcionASMXSoap)(this)).fnEnviarXML(inValue);
