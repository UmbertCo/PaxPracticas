...
namespace wcfTimbrado.wsRecepcionTimbrado {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://test.paxfacturacion.com.mx:453", ConfigurationName="wsRecepcionTimbrado.wcfRecepcionASMXSoap")]
    public interface wcfRecepcionASMXSoap {
        ...
        wcfTimbrado.wsRecepcionTimbrado.fnEnviarXMLResponse fnEnviarXML(wcfTimbrado.wsRecepcionTimbrado.fnEnviarXMLRequest request);
    }
    ...
    public partial class fnEnviarXMLRequest {
        ...
        public wcfTimbrado.wsRecepcionTimbrado.fnEnviarXMLRequestBody Body;
        
        public fnEnviarXMLRequest() {
        }
        
        public fnEnviarXMLRequest(wcfTimbrado.wsRecepcionTimbrado.fnEnviarXMLRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class fnEnviarXMLResponse {
        ...
        public wcfTimbrado.wsRecepcionTimbrado.fnEnviarXMLResponseBody Body;
        
        public fnEnviarXMLResponse() {
        }
        
        public fnEnviarXMLResponse(wcfTimbrado.wsRecepcionTimbrado.fnEnviarXMLResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface wcfRecepcionASMXSoapChannel : wcfTimbrado.wsRecepcionTimbrado.wcfRecepcionASMXSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class wcfRecepcionASMXSoapClient : System.ServiceModel.ClientBase<wcfTimbrado.wsRecepcionTimbrado.wcfRecepcionASMXSoap>, wcfTimbrado.wsRecepcionTimbrado.wcfRecepcionASMXSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        wcfTimbrado.wsRecepcionTimbrado.fnEnviarXMLResponse wcfTimbrado.wsRecepcionTimbrado.wcfRecepcionASMXSoap.fnEnviarXML(wcfTimbrado.wsRecepcionTimbrado.fnEnviarXMLRequest request) {
        ...
        public string fnEnviarXML(string psComprobante, string psTipoDocumento, int pnId_Estructura, string sNombre, string sContraseña, string sVersion) {
            wcfTimbrado.wsRecepcionTimbrado.fnEnviarXMLRequest inValue = new wcfTimbrado.wsRecepcionTimbrado.fnEnviarXMLRequest();
            inValue.Body = new wcfTimbrado.wsRecepcionTimbrado.fnEnviarXMLRequestBody();
            ...
            wcfTimbrado.wsRecepcionTimbrado.fnEnviarXMLResponse retVal = ((wcfTimbrado.wsRecepcionTimbrado.wcfRecepcionASMXSoap)(this)).fnEnviarXML(inValue);
