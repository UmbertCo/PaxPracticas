...
namespace PDFSharpPlantillaNomina
{
    class PDFSharpNomina
    {
        ...
        private double puntoY = 300; // Punto donde se comenzara a dibujar el panel de percepciones /Deducciones
        ...
        static void Main(string[] args)
        {
            ...
            xmlDOC.Load(@"C:\Users\Marco.Santana\Documents\Visual Studio 2010\Projects\PDFSharpPlantillaNomina\prueba.xml");
        ...
        public PDFSharpNomina(XmlDocument pxComprobante)
        {
            ...
            try { logo = XImage.FromGdiPlusImage(Resource.maxresdefault); }
            catch { }
        ...
        public void fnGenerarPDF() 
        {
            ...
            fuente1 = new XFont("Wingdings 3", 14, XFontStyle.Bold);
            fuente2 = new XFont("Wingdings 3", 12, XFontStyle.Regular);
            fuente3 = new XFont("Wingdings 3", 8, XFontStyle.Bold);
            fuente4 = new XFont("Wingdings 3", 8, XFontStyle.Regular);
            negrita = new XFont("Wingdings 3", 12, XFontStyle.Bold);

            fnDibujarEncabezadoPiePagina(ref gfx);
            fnDibujarContenido(ref gfx);
            ...
            {
                grafix.DrawString(Convert.ToString(nomina.PageCount), fuente4, XBrushes.Black, 515, 805, formatoLeft); 
            }
        ...
        public void fnDibujarPiePagina(ref XGraphics gfx) 
        {
            ...
            gfx.DrawString("http://www.paxfacturacion.com/", fuente4, XBrushes.Black, 50, 805, formatoLeft);
            gfx.DrawString(leyendaPDF, fuente4, XBrushes.Black, 170, 805, formatoLeft);
            gfx.DrawString(Convert.ToString(nomina.PageCount) + " de", fuente4, XBrushes.Black, 500, 805, formatoLeft);
        }

        public void fnDibujarContenido(ref XGraphics gfx) 
        {
            fnCrearPanelDatosEmpleado(ref gfx);
            fnCrearPanelInformacionLaboral(ref gfx);
            fnCrearPanelInformacionGeneral(ref gfx);
        }
        ...
        public void fnDatosPanelEmisor(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, ref XGraphics gfx) 
        {
            ...
            gfx.DrawString(sEmisor, negrita, XBrushes.Black, new Point(120, 30), formatoLeft);
            gfx.DrawString(sDireccion1, fuente2, XBrushes.Black, new Point(120, 50), formatoLeft);
            gfx.DrawString(sDireccion2, fuente2, XBrushes.Black, new Point(120, 60), formatoLeft);
            gfx.DrawString("RFC: " + sRFC, fuente2, XBrushes.Black, new Point(120, 70), formatoLeft);
            gfx.DrawString("Registro Patronal: " + sRegistroPatronal, fuente2, XBrushes.Black, new Point(120, 80), formatoLeft);
            gfx.DrawString("Registro Fiscal: " + sRegimenFiscal, fuente2, XBrushes.Black, new Point(120, 90), formatoLeft);
        ...
        public void fnCrearPanelRecibo(ref XGraphics gfx) 
        {
            ...
            //gfx.DrawRoundedRectangle(XBrushes.Navy, rect, new Size(10,10));
            gfx.DrawRoundedRectangle(pen, XBrushes.White, 370, 10, 210, 52, 20, 20);
            gfx.DrawLine(pen, 370, 30, 580, 30);

            gfx.DrawString("RECIBO DE NÓMINA", fuente1, XBrushes.Black, new Point(500, 20), XStringFormats.Center);
            gfx.DrawString("Folio Fiscal:", negrita, XBrushes.Black, new Point(570, 40), formatoRight);
            gfx.DrawString("No. de Serie del certificado del emisor:", negrita, XBrushes.Black, new Point(570, 60), formatoRight);
            gfx.DrawString("No. de Serie del certificado del SAT:", negrita, XBrushes.Black, new Point(570, 80), formatoRight);
            gfx.DrawString("Fecha y hora de certificacion:", negrita, XBrushes.Black, new Point(570, 100), formatoRight);
            gfx.DrawString("Lugar, fecha y hora de emision:", negrita, XBrushes.Black, new Point(570, 120), formatoRight);
        ...
        public void fnDatosPanelRecibo(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, ref XGraphics gfx) 
        {
            ...
            gfx.DrawString(sFolioFiscal, fuente2, XBrushes.Black, new Point(570, 50), formatoRight);
            gfx.DrawString(sCertificadoEmisor, fuente2, XBrushes.Black, new Point(570, 70), formatoRight);
            gfx.DrawString(sCertificadoSAT, fuente2, XBrushes.Black, new Point(570, 90), formatoRight);
            gfx.DrawString(sFechaCertificacion, fuente2, XBrushes.Black, new Point(570, 110), formatoRight);
            gfx.DrawString(sLugarEmision + " " + sFechaEmision, fuente2, XBrushes.Black, new Point(570, 130), formatoRight);
        ...
        public void fnDatosPanelExpedidoEn(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, ref XGraphics gfx) 
        {
            ...
            if (sCalle != string.Empty)
            {
                ...
                gfx.DrawString("Expedido En:", negrita, XBrushes.Black, new Point(20, 110), formatoLeft);
                gfx.DrawString(sDireccion1, fuente2, XBrushes.Black, new Point(20, 120), formatoLeft);
                gfx.DrawString(sDireccion2, fuente2, XBrushes.Black, new Point(20, 130), formatoLeft);
            }

        }

        public void fnCrearPanelDatosEmpleado(ref XGraphics gfx) 
        {
            gfx.DrawRoundedRectangle(pen, XBrushes.White, 12, 160, 570, 12, 10, 10);

            gfx.DrawString("Datos del Empleado", negrita, XBrushes.Black, new Point(20, 160), formatoLeft);
            gfx.DrawString("Nombre:", negrita, XBrushes.Black, new Point(20, 170), formatoLeft);
            gfx.DrawString("RFC:", negrita, XBrushes.Black, new Point(20, 180), formatoLeft);
            gfx.DrawString("N.N.S.:", negrita, XBrushes.Black, new Point(20, 190), formatoLeft);
            gfx.DrawString("Departamento:", negrita, XBrushes.Black, new Point(20, 200), formatoLeft);
            gfx.DrawString("Riesgo Puesto:", negrita, XBrushes.Black, new Point(20, 210), formatoLeft);

            gfx.DrawString("No. Empleado:", negrita, XBrushes.Black, new Point(300, 170), formatoLeft);
            gfx.DrawString("CURP:", negrita, XBrushes.Black, new Point(300, 180), formatoLeft);
            gfx.DrawString("Régimen:", negrita, XBrushes.Black, new Point(300, 190), formatoLeft);
            gfx.DrawString("Puesto:", negrita, XBrushes.Black, new Point(300, 200), formatoLeft);

            fnDatosPanelEmpleado(nsmComprobante, navEncabezado, ref gfx);

        }

        public void fnDatosPanelEmpleado(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, ref XGraphics gfx) 
        {
            ...
            gfx.DrawString(sNombre, fuente2, XBrushes.Black, new Point(100, 170), formatoLeft);
            gfx.DrawString(sRFC, fuente2, XBrushes.Black, new Point(100, 180), formatoLeft);
            gfx.DrawString(sNNS, fuente2, XBrushes.Black, new Point(100, 190), formatoLeft);
            gfx.DrawString(sDepartamento, fuente2, XBrushes.Black, new Point(100, 200), formatoLeft);
            gfx.DrawString(sRiesgoPuesto, fuente2, XBrushes.Black, new Point(100, 210), formatoLeft);

            gfx.DrawString(sNoEmpleado, fuente2, XBrushes.Black, new Point(400, 170), formatoLeft);
            gfx.DrawString(sCURP, fuente2, XBrushes.Black, new Point(400, 180), formatoLeft);
            gfx.DrawString(sRegimen, fuente2, XBrushes.Black, new Point(400, 190), formatoLeft);
            gfx.DrawString(sPuesto, fuente2, XBrushes.Black, new Point(400, 200), formatoLeft);
        
        }

        public void fnCrearPanelInformacionLaboral(ref XGraphics gfx) 
        {
            gfx.DrawRoundedRectangle(pen, XBrushes.White, 12, 210, 570, 12, 10, 10);

            gfx.DrawString("Información Laboral", negrita, XBrushes.Black, new Point(20, 210), formatoLeft);
            gfx.DrawString("Contrato:", negrita, XBrushes.Black, new Point(20, 220), formatoLeft);
            gfx.DrawString("Periodo:", negrita, XBrushes.Black, new Point(20, 230), formatoLeft);
            gfx.DrawString("Antigüedad:", negrita, XBrushes.Black, new Point(20, 240), formatoLeft);
            gfx.DrawString("Salario Base:", negrita, XBrushes.Black, new Point(20, 250), formatoLeft);
            gfx.DrawString("Jornada:", negrita, XBrushes.Black, new Point(20, 260), formatoLeft);

            //gfx.DrawString("Folio:", negrita, XBrushes.Black, new Point(300, 210), formatoLeft);
            gfx.DrawString("Fecha de Pago:", negrita, XBrushes.Black, new Point(300, 220), formatoLeft);
            gfx.DrawString("Dias Pagados:", negrita, XBrushes.Black, new Point(300, 230), formatoLeft);
            gfx.DrawString("Salario Diario:", negrita, XBrushes.Black, new Point(300, 240), formatoLeft);

            fnDatosPanelInformacionLaboral(nsmComprobante, navEncabezado, ref gfx);

        }

        public void fnDatosPanelInformacionLaboral(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, ref XGraphics gfx) 
        {
            ...
            gfx.DrawString(sContrato, fuente2, XBrushes.Black, new Point(100, 220), formatoLeft);
            gfx.DrawString(sPeriodo, fuente2, XBrushes.Black, new Point(100, 230), formatoLeft);
            gfx.DrawString(sAntiguedad, fuente2, XBrushes.Black, new Point(100, 240), formatoLeft);
            gfx.DrawString(sSalarioBase, fuente2, XBrushes.Black, new Point(100, 250), formatoLeft);
            gfx.DrawString(sJornada, fuente2, XBrushes.Black, new Point(100, 260), formatoLeft);

            //gfx.DrawString(sFolio, fuente2, XBrushes.Black, new Point(400, 220), formatoLeft);
            gfx.DrawString(sFechaPago, fuente2, XBrushes.Black, new Point(400, 220), formatoLeft);
            gfx.DrawString(sDiasPagados, fuente2, XBrushes.Black, new Point(400, 230), formatoLeft);
            gfx.DrawString(sSalarioDiario, fuente2, XBrushes.Black, new Point(400, 240), formatoLeft);

        }

        public void fnCrearPanelInformacionGeneral(ref XGraphics gfx) 
        {
            gfx.DrawRoundedRectangle(pen, XBrushes.White, 12, 260, 570, 12, 10, 10);

            gfx.DrawString("Información General", negrita, XBrushes.Black, new Point(20, 260), formatoLeft);
            gfx.DrawString("Delegación/Municipio:", negrita, XBrushes.Black, new Point(20, 270), formatoLeft);
            gfx.DrawString("Banco:", negrita, XBrushes.Black, new Point(20, 280), formatoLeft);
            gfx.DrawString("CLABE:", negrita, XBrushes.Black, new Point(20, 290), formatoLeft);

            gfx.DrawString("Forma de Pago:", negrita, XBrushes.Black, new Point(300, 270), formatoLeft);
            gfx.DrawString("Método de Pago:", negrita, XBrushes.Black, new Point(300, 280), formatoLeft);
            fnDatosPanelInformacionGeneral(nsmComprobante, navEncabezado, ref gfx);
        }

        public void fnDatosPanelInformacionGeneral(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, ref XGraphics gfx) 
        {
            ...
            gfx.DrawString(sDelegacion, fuente2, XBrushes.Black, new Point(150, 270), formatoLeft);
            gfx.DrawString(sBanco, fuente2, XBrushes.Black, new Point(150, 280), formatoLeft);
            gfx.DrawString(sClabe, fuente2, XBrushes.Black, new Point(150, 290), formatoLeft);

            gfx.DrawString(sFormaPago, fuente2, XBrushes.Black, new Point(400, 270), formatoLeft);
            gfx.DrawString(sMetodoPago, fuente2, XBrushes.Black, new Point(400, 280), formatoLeft);
        ...
        public void fnCrearEncabezadoPercepciones(ref XGraphics gfx, ref double posY) 
        {
            ...
            gfx.DrawString("PERCEPCIONES", negrita, XBrushes.White, 20, posY, formatoLeft);
            posY += 12;
            gfx.DrawString("Tipo", fuente3, XBrushes.Black, 20, posY, formatoLeft);
            gfx.DrawString("Clave", fuente3, XBrushes.Black, 70, posY, formatoLeft);
            gfx.DrawString("Concepto", fuente3, XBrushes.Black, 150, posY, formatoLeft);
            gfx.DrawString("Importe Gravado", fuente3, XBrushes.Black, 400, posY, formatoLeft);
            gfx.DrawString("Importe Exento", fuente3, XBrushes.Black, 500, posY, formatoLeft);
            posY += 10;
        }
        ...
        public void fnDibujaDatosPanelPercepciones(ref XGraphics gfx, ref double posY, string sTipo, string sClave, string sConcepto, string sImporteGravado, string sImporteEcento) 
        {
            ...
            double pos = posY;
            gfx.DrawString(sTipo, fuente4, XBrushes.Black, 20, pos, formatoLeft);
            gfx.DrawString(sClave, fuente4, XBrushes.Black, 70, pos, formatoLeft);
           // posY = fnEscribirMultilinea2(sConcepto, 60, 10, 140, posY, fuente4, ref gfx);
            posY = fnEscribirMultilinea2(sConcepto,60,140,posY,fuente4,ref gfx);
            // gfx.DrawString(sConcepto, fuente4, XBrushes.Black, 150, posY, formatoLeft);
            gfx.DrawString(sImporteGravado, fuente4, XBrushes.Black, 400, pos, formatoLeft);
            gfx.DrawString(sImporteEcento, fuente4, XBrushes.Black, 500, pos, formatoLeft);
        ...
        public void fnCrearEncabezadoHorasExtra(ref XGraphics gfx, ref double posY) 
        {
            ...
            gfx.DrawString("Días", fuente3, XBrushes.Black, 20, posY, formatoLeft);
            gfx.DrawString("Horas Extra", fuente3, XBrushes.Black, 70, posY, formatoLeft);
            gfx.DrawString("Tipo Hora", fuente3, XBrushes.Black, 300, posY, formatoLeft);
            gfx.DrawString("Importe Pagado", fuente3, XBrushes.Black, 500, posY, formatoLeft);
        ...
        public void fnDibujaDatosPanelHorasExtra(ref XGraphics gfx, ref double posY, string sDias, string sHorasExtra, string sTipoHora, string sImportePagado) 
        {
            ...
            gfx.DrawString(sDias, fuente4, XBrushes.Black, 20, posY, formatoLeft);
            gfx.DrawString(sHorasExtra, fuente4, XBrushes.Black, 70, posY, formatoLeft);
            gfx.DrawString(sTipoHora, fuente4, XBrushes.Black, 300, posY, formatoLeft);
            gfx.DrawString(sImportePagado, fuente4, XBrushes.Black, 500, posY, formatoLeft);
        ...
        public void fnCrearPanelSumaPercepciones(ref XGraphics gfx, ref double posY) 
        {
            ...
            gfx.DrawRoundedRectangle(pen, XBrushes.White, 12, posY, 570, 12, 10, 10);
            gfx.DrawString("Suma Percepciones", fuente3, XBrushes.Black, 400, posY, formatoLeft);
            gfx.DrawString(sSumaPercepciones, fuente3, XBrushes.Black, 500, posY, formatoLeft);
            posY += 12;
        }
        ...
        {
            gfx.DrawRoundedRectangle(pen, XBrushes.Navy, 12, posY, 570, 12, 10, 10);
            gfx.DrawString("DEDUCCIONES", negrita, XBrushes.White, 20, posY, formatoLeft);
            posY += 12;
            gfx.DrawString("Tipo", fuente3, XBrushes.Black, 20, posY, formatoLeft);
            gfx.DrawString("Clave", fuente3, XBrushes.Black, 70, posY, formatoLeft);
            gfx.DrawString("Concepto", fuente3, XBrushes.Black, 150, posY, formatoLeft);
        ...
        public void fnDibujaDatosPanelDeducciones(ref XGraphics gfx, ref double posY, string sTipo, string sClave,string  sConcepto, string sImporteGravado, string  sImporteExcento) 
        {
            ...
            //gfx.DrawString(sConcepto, fuente4, XBrushes.Black, 150, posY, formatoLeft);
            gfx.DrawString(sImporteGravado, fuente4, XBrushes.Black, 400, pos, formatoLeft);
            gfx.DrawString(sImporteExcento, fuente4, XBrushes.Black, 500, pos, formatoLeft);
        ...
        {
            gfx.DrawRoundedRectangle(pen, XBrushes.White, 12, posY, 570, 12, 10, 10);
            gfx.DrawString("Días de incapacidad", fuente3, XBrushes.Black, 20, posY, formatoLeft);
            gfx.DrawString("Tipo de incapacidad", fuente3, XBrushes.Black, 300, posY, formatoLeft);
            gfx.DrawString("Descuento", fuente3, XBrushes.Black, 500, posY, formatoLeft);
            posY += 12;
        }
        ...
        public void fnDibujaDatosPanelIncapacidad(ref XGraphics gfx, ref double posY, string sDiasIncapacidad, string sTipoIncapacidad, string sDescuento) 
        {
            ...
            gfx.DrawString(sDiasIncapacidad, fuente4, XBrushes.Black, 20, posY, formatoLeft);
            gfx.DrawString(sTipoIncapacidad, fuente4, XBrushes.Black, 300, posY, formatoLeft);
            gfx.DrawString(sDescuento, fuente4, XBrushes.Black, 500, posY, formatoLeft);
            posY += 10;
        }
        ...
        public void fnCrearPanelSumaDeducciones(ref XGraphics gfx, ref double posY)
        {
            ...
            gfx.DrawRoundedRectangle(pen, XBrushes.White, 12, posY, 570, 12, 10, 10);
            gfx.DrawString("Suma Deducciones", fuente3, XBrushes.Black, 400, posY, formatoLeft);
            gfx.DrawString(sSumaDeducciones, fuente3, XBrushes.Black, 500, posY, formatoLeft);
            posY += 12;
        }
        ...
        public void fnDibujarPanelTotales(ref XGraphics gfx)
        {
            ...
            gfx.DrawString("Total con letra:", negrita, XBrushes.Black, new Point(115, 590), formatoLeft);
            gfx.DrawString("SubTotal", fuente3, XBrushes.Black, new Point(450, 590), formatoLeft);
            gfx.DrawString("Descuentos", fuente3, XBrushes.Black, new Point(450, 610), formatoLeft);
            gfx.DrawString("ISR", fuente3, XBrushes.Black, new Point(450, 620), formatoLeft);

            gfx.DrawLine(pen, 415, 675, 570, 675);
            gfx.DrawString("TOTAL", negrita, XBrushes.Black, new Point(415, 675), formatoLeft);
        ...
        public void fnDatosPanelTotales(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, ref XGraphics gfx)
        {
            ...
            gfx.DrawString(fnTextoImporte(sTotal, "MXN"), fuente4, XBrushes.Black, new Point(115, 600), formatoLeft);
            gfx.DrawString(sSubTotal, fuente4, XBrushes.Black, new Point(570, 590), formatoRight);
            gfx.DrawString(sDescuentos, fuente4, XBrushes.Black, new Point(570, 610), formatoRight);
            gfx.DrawString(sISR, fuente4, XBrushes.Black, new Point(570, 620), formatoRight);
            gfx.DrawString(sTotal, fuente4, XBrushes.Black, new Point(570, 675), formatoRight);
        ...
        public void fnDibujarPanelSellos(ref XGraphics gfx)
        {
            ...
            gfx.DrawString("Sello digital del Emisor:", fuente4, XBrushes.Black, new Point(15, 695), formatoLeft);
            gfx.DrawString("Sello digital del SAT:", fuente4, XBrushes.Black, new Point(15, 720), formatoLeft);
            gfx.DrawString("Cadena Original del complemento de certificación digital del SAT:", fuente4, XBrushes.Black, new Point(15, 755), formatoLeft);
        ...
        public void fnDatosPanelSellos(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, ref XGraphics gfx)
        {
            ...
            sSelloEmisor = sSelloSat = sCadenaOriginal = sSubTotal = sDescuentos = sISR = sTotalConLetra = sTotal = "";
            ...
            puntoY = 700;
            //puntoY = fnEscribirMultilinea2(sSelloEmisor, 130, 6, 15, puntoY, fuente4, ref gfx);
            puntoY = fnEscribirMultilinea2(sSelloEmisor, 130, 15, puntoY, fuente4, ref gfx);
            puntoY = 730;
            //puntoY = fnEscribirMultilinea2(sSelloSat, 130, 6, 15, puntoY, fuente4, ref gfx);
            puntoY = fnEscribirMultilinea2(sSelloSat, 130, 15, puntoY, fuente4, ref gfx);
            puntoY = 765;
            //puntoY = fnEscribirMultilinea2(sCadenaOriginal, 130, 6, 15, puntoY, fuente4, ref gfx);
            puntoY = fnEscribirMultilinea2(sCadenaOriginal, 130, 15, puntoY, fuente4, ref gfx);            
        }
        ...
        public void fnRectanguloMultilinea(string sLinea, XFont fuente, double posX, double posY, double tamX, ref XGraphics gfx, int nCaracteres) 
        {
            XTextFormatter tf = new XTextFormatter(gfx);
            XRect rect = new XRect(posX,posY , tamX,fuente.Height);
            gfx.DrawRectangle(XBrushes.HotPink, rect);
            sLinea = fnBreakString(sLinea, nCaracteres);
            tf.DrawString("abc", fuente4, XBrushes.Black, rect, XStringFormats.TopLeft);
           // tf.Text.
        ...
        /// <summary>
        /// Escribe Multilinea, especificando la separacion que tendra el renglon en caso de salto de linea
        /// </summary>
        /// <param name="sLinea">Cadena a escribir</param>
        /// <param name="nCaracteres">Numero de caracteres permitidos por renglon</param>
        /// <param name="nSeparacion">Especifica cuanto se incrementara en la posicion Y cuando se dibuje el siguiente renglon</param>
        ...
        /// <returns></returns>
        public double fnEscribirMultilinea1(string sLinea, int nCaracteres, double nSeparacion, double posX, double posY,  XFont xFuente, ref XGraphics gfx)
        {
            sLinea = sLinea.Replace("\n", "");
            sLinea = sLinea.Replace("\r", "");
            
            double separacionLetra = xFuente.Size *.5;
        ...
        /// <param name="gfx">Objeto XGraphics</param>
        /// <returns></returns>
        public double fnEscribirMultilinea2(string sLinea, int nCaracteres, double posX, double posY, XFont xFuente, ref XGraphics gfx) 
        {
            sLinea = sLinea.Replace("\n", "");
            sLinea = sLinea.Replace("\r", "");
