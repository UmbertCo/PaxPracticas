...
namespace SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://test.paxfacturacion.com.mx:453", ConfigurationName="wsTimbrado.wcfRecepcionASMXSoap")]
    public interface wcfRecepcionASMXSoap {
        ...
        SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.fnEnviarXMLResponse fnEnviarXML(SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.fnEnviarXMLRequest request);
    }
    ...
    public partial class fnEnviarXMLRequest {
        ...
        public SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.fnEnviarXMLRequestBody Body;
        
        public fnEnviarXMLRequest() {
        }
        
        public fnEnviarXMLRequest(SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.fnEnviarXMLRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class fnEnviarXMLResponse {
        ...
        public SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.fnEnviarXMLResponseBody Body;
        
        public fnEnviarXMLResponse() {
        }
        
        public fnEnviarXMLResponse(SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.fnEnviarXMLResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface wcfRecepcionASMXSoapChannel : SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.wcfRecepcionASMXSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class wcfRecepcionASMXSoapClient : System.ServiceModel.ClientBase<SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.wcfRecepcionASMXSoap>, SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.wcfRecepcionASMXSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.fnEnviarXMLResponse SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.wcfRecepcionASMXSoap.fnEnviarXML(SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.fnEnviarXMLRequest request) {
        ...
        public string fnEnviarXML(string psComprobante, string psTipoDocumento, int pnId_Estructura, string sNombre, string sContraseña, string sVersion) {
            SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.fnEnviarXMLRequest inValue = new SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.fnEnviarXMLRequest();
            inValue.Body = new SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.fnEnviarXMLRequestBody();
            ...
            SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.fnEnviarXMLResponse retVal = ((SolucionPruebas.Presentacion.ConsoleApplication.ValidacionINE.wsTimbrado.wcfRecepcionASMXSoap)(this)).fnEnviarXML(inValue);
