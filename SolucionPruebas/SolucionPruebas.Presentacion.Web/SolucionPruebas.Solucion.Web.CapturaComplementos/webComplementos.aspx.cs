...
public partial class webComplementos : System.Web.UI.Page
{
    ...
    private static void fnIniciarlizarTablaComplementos()
    {
        ...
        htComplementos.Add("consumodecombustibles", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("catComExt", @"D:\Forms Dinamicos\Plantillas\Plantilla_ComercioExterior.xslt");
        ...
        htComplementos.Add("Donatarias", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("ECC", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("EEC11", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("IEDU", @"D:\Forms Dinamicos\Plantillas\Plantilla_IEDU.xslt");
        htComplementos.Add("ImpLocal", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("ine", @"D:\Forms Dinamicos\Plantillas\Plantilla_INE11.xslt");
        htComplementos.Add("LeyendasFiscales", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        ...
        htComplementos.Add("notariospublicos", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("obrasarteantiguedades", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("pagoenespecie", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("Pagos10", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("PFIC", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("renovacionysustitucionvehiculos", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("servicioparcialconstruccion", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("SPEI", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("Terceros", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("TuristaPasajeroExtranjero", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("valesdedespensa", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("vehiculousado", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
        htComplementos.Add("ventavehiculos", @"D:\Forms Dinamicos\Plantillas\Plantilla_base.xslt");
    }
}