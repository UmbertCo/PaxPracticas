<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="webConsultasCFDI.aspx.cs" Inherits="SolucionPruebas.Presentacion.Web.Consultas.webConsultasCFDI" %>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="lblSerie" runat="server" 
                                    ...
                                    AssociatedControlID="ddlSeries" Visible="False"></asp:Label>
                                <asp:DropDownList ID="ddlSeries" runat="server" DataTextField="serie" 
                                    DataValueField="serie" Visible="False">
                                </asp:DropDownList>
                            </td>
                            <td>
                                ...
                                <asp:TextBox ID="txtUUID" runat="server" MaxLength="128" Visible="False"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:Label ID="lblFolioIni" runat="server" 
                                    ...
                                    AssociatedControlID="txtFolioIni" Visible="False"></asp:Label>
                                <asp:TextBox ID="txtFolioIni" runat="server" MaxLength="19" Width="100px" 
