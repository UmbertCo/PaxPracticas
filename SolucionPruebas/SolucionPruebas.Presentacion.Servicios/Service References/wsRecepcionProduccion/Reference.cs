...
namespace SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://www.paxfacturacion.com.mx:453", ConfigurationName="wsRecepcionProduccion.wcfRecepcionASMXSoap")]
    public interface wcfRecepcionASMXSoap {
        ...
        SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.fnEnviarXMLResponse fnEnviarXML(SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.fnEnviarXMLRequest request);
    }
    ...
    public partial class fnEnviarXMLRequest {
        ...
        public SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.fnEnviarXMLRequestBody Body;
        
        public fnEnviarXMLRequest() {
        }
        
        public fnEnviarXMLRequest(SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.fnEnviarXMLRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class fnEnviarXMLResponse {
        ...
        public SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.fnEnviarXMLResponseBody Body;
        
        public fnEnviarXMLResponse() {
        }
        
        public fnEnviarXMLResponse(SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.fnEnviarXMLResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface wcfRecepcionASMXSoapChannel : SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.wcfRecepcionASMXSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class wcfRecepcionASMXSoapClient : System.ServiceModel.ClientBase<SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.wcfRecepcionASMXSoap>, SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.wcfRecepcionASMXSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.fnEnviarXMLResponse SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.wcfRecepcionASMXSoap.fnEnviarXML(SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.fnEnviarXMLRequest request) {
        ...
        public string fnEnviarXML(string psComprobante, string psTipoDocumento, int pnId_Estructura, string sNombre, string sContraseña, string sVersion) {
            SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.fnEnviarXMLRequest inValue = new SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.fnEnviarXMLRequest();
            inValue.Body = new SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.fnEnviarXMLRequestBody();
            ...
            SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.fnEnviarXMLResponse retVal = ((SolucionPruebas.Presentacion.Servicios.wsRecepcionProduccion.wcfRecepcionASMXSoap)(this)).fnEnviarXML(inValue);
