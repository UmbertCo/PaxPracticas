...
namespace SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://test.paxfacturacion.com.mx:453", ConfigurationName="wsRecepcionTestASMX.wcfRecepcionASMXSoap")]
    public interface wcfRecepcionASMXSoap {
        ...
        SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.fnEnviarXMLResponse fnEnviarXML(SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.fnEnviarXMLRequest request);
    }
    ...
    public partial class fnEnviarXMLRequest {
        ...
        public SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.fnEnviarXMLRequestBody Body;
        
        public fnEnviarXMLRequest() {
        }
        
        public fnEnviarXMLRequest(SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.fnEnviarXMLRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class fnEnviarXMLResponse {
        ...
        public SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.fnEnviarXMLResponseBody Body;
        
        public fnEnviarXMLResponse() {
        }
        
        public fnEnviarXMLResponse(SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.fnEnviarXMLResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface wcfRecepcionASMXSoapChannel : SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.wcfRecepcionASMXSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class wcfRecepcionASMXSoapClient : System.ServiceModel.ClientBase<SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.wcfRecepcionASMXSoap>, SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.wcfRecepcionASMXSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.fnEnviarXMLResponse SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.wcfRecepcionASMXSoap.fnEnviarXML(SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.fnEnviarXMLRequest request) {
        ...
        public string fnEnviarXML(string psComprobante, string psTipoDocumento, int pnId_Estructura, string sNombre, string sContraseña, string sVersion) {
            SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.fnEnviarXMLRequest inValue = new SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.fnEnviarXMLRequest();
            inValue.Body = new SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.fnEnviarXMLRequestBody();
            ...
            SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.fnEnviarXMLResponse retVal = ((SolucionPruebas.Presentacion.Servicios.wsRecepcionTestASMX.wcfRecepcionASMXSoap)(this)).fnEnviarXML(inValue);
