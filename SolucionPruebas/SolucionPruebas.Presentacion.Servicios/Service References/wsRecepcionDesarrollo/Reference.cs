...
namespace SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://www.paxfacturacion.com.mx:453", ConfigurationName="wsRecepcionDesarrollo.wcfRecepcionASMXSoap")]
    public interface wcfRecepcionASMXSoap {
        ...
        SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.fnEnviarXMLResponse fnEnviarXML(SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.fnEnviarXMLRequest request);
    }
    ...
    public partial class fnEnviarXMLRequest {
        ...
        public SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.fnEnviarXMLRequestBody Body;
        
        public fnEnviarXMLRequest() {
        }
        
        public fnEnviarXMLRequest(SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.fnEnviarXMLRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class fnEnviarXMLResponse {
        ...
        public SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.fnEnviarXMLResponseBody Body;
        
        public fnEnviarXMLResponse() {
        }
        
        public fnEnviarXMLResponse(SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.fnEnviarXMLResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface wcfRecepcionASMXSoapChannel : SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.wcfRecepcionASMXSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class wcfRecepcionASMXSoapClient : System.ServiceModel.ClientBase<SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.wcfRecepcionASMXSoap>, SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.wcfRecepcionASMXSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.fnEnviarXMLResponse SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.wcfRecepcionASMXSoap.fnEnviarXML(SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.fnEnviarXMLRequest request) {
        ...
        public string fnEnviarXML(string psComprobante, string psTipoDocumento, int pnId_Estructura, string sNombre, string sContraseña, string sVersion) {
            SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.fnEnviarXMLRequest inValue = new SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.fnEnviarXMLRequest();
            inValue.Body = new SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.fnEnviarXMLRequestBody();
            ...
            SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.fnEnviarXMLResponse retVal = ((SolucionPruebas.Presentacion.Servicios.wsRecepcionDesarrollo.wcfRecepcionASMXSoap)(this)).fnEnviarXML(inValue);
