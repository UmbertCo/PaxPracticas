...
namespace SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://test.paxfacturacion.com:458/", ConfigurationName="wsRecepcionLocalRetencion.wcfRecepcionASMXSoap")]
    public interface wcfRecepcionASMXSoap {
        ...
        SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.fnEnviarXMLResponse fnEnviarXML(SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.fnEnviarXMLRequest request);
    }
    ...
    public partial class fnEnviarXMLRequest {
        ...
        public SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.fnEnviarXMLRequestBody Body;
        
        public fnEnviarXMLRequest() {
        }
        
        public fnEnviarXMLRequest(SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.fnEnviarXMLRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class fnEnviarXMLResponse {
        ...
        public SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.fnEnviarXMLResponseBody Body;
        
        public fnEnviarXMLResponse() {
        }
        
        public fnEnviarXMLResponse(SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.fnEnviarXMLResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface wcfRecepcionASMXSoapChannel : SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.wcfRecepcionASMXSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class wcfRecepcionASMXSoapClient : System.ServiceModel.ClientBase<SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.wcfRecepcionASMXSoap>, SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.wcfRecepcionASMXSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.fnEnviarXMLResponse SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.wcfRecepcionASMXSoap.fnEnviarXML(SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.fnEnviarXMLRequest request) {
        ...
        public string fnEnviarXML(string psComprobante, int psCveRetencion, int pnId_Estructura, string sNombre, string sContrasena, string sVersion) {
            SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.fnEnviarXMLRequest inValue = new SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.fnEnviarXMLRequest();
            inValue.Body = new SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.fnEnviarXMLRequestBody();
            ...
            SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.fnEnviarXMLResponse retVal = ((SolucionPruebas.Presentacion.Servicios.wsRecepcionLocalRetencion.wcfRecepcionASMXSoap)(this)).fnEnviarXML(inValue);
