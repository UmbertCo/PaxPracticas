...
public class clsOperacionConsultaPdfV2
{
	...
	private string fnTextoImporte(string psValor, string psMoneda)
	{
		...
		NumaletPago parser = new NumaletPago();
        parser.LetraCapital = true;

		switch (psMoneda)
		{
			case "MXN":
				parser.TipoMoneda = NumaletPago.Moneda.Peso;
				break;
			case "USD":
				parser.TipoMoneda = NumaletPago.Moneda.Dolar;
				break;
			case "XEU":
				parser.TipoMoneda = NumaletPago.Moneda.Euro;
				break;
		}
