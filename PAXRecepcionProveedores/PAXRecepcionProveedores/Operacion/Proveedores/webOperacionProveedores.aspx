<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="webOperacionProveedores.aspx.cs" Inherits="PAXRecepcionProveedores.Operacion.Proveedores.webOperacionProveedores" %>
...
<br /><br /><br />
                                ...
                                <td align="center"><asp:Label ID="lblSeleccionSucursal" runat="server" 
                                    ...
                                    <div style="overflow:auto; width: 630px; height:200px">
                                        <asp:GridView ID="gvSucursales" runat="server" AutoGenerateColumns="False" 
                                            ...
                                            Width="600px" TabIndex="17" Height="192px">
                                            <Columns>
    ...
    <asp:GridView ID="gvProveedores" runat="server" BackColor="White" 
         ...
         CellSpacing="1" GridLines="None" AutoGenerateSelectButton="True" AutoGenerateColumns="false" 
         ...
         <Columns>
            ...
            <asp:TemplateField HeaderText="<%$ Resources:resCorpusCFDIEs, lblContacto %>" ItemStyle-HorizontalAlign="Left">
                <ItemTemplate>
                    <asp:Label ID="lblGvContacto" runat="server" Text='<%# Bind("nombre") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
