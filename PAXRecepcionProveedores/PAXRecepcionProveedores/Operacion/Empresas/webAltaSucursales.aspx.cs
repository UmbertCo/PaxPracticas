...
{
    public partial class webAltaSucursales : System.Web.UI.Page
    {
        ...
        /// <summary>
        /// Obtiene el catálogo de tipo de plantillas
        /// </summary>
        private void fnObtenerTipoPlantillas()
        {
            DataTable dtPlantillas = new clsOperacionSucursales().fnObtenerTiposPlantilla();
            ddlTipoPlantilla.DataSource = dtPlantillas;
            ddlTipoPlantilla.DataTextField = "nombre";
            ddlTipoPlantilla.DataValueField = "id_tipo_plantilla";
        ...
        protected void btnGuardarEmpresa_Click(object sender, EventArgs e)
        {
            ...
            {
                clsComun.fnMostrarMensaje(this, Resources.resCorpusCFDIEs.varUnCorreo);
                txtCorreo.Focus();
                return;
            }
            ...
            try
            {
                ...
                if(nIdEmpresa<=0)
                {
                    clsComun.fnMostrarMensaje(this, Resources.resCorpusCFDIEs.varRegistreEmpresa);
                        return;
                }
                int nIdMunicipio = 0;
                ...
                int nTipoPlantilla = Convert.ToInt32(ddlTipoPlantilla.SelectedValue);
                clsInicioSesionUsuario usuarioActivo = clsComun.fnUsuarioEnSesion();
                //Guarda la sucursal
                 nIdSucursal = new clsOperacionSucursales().fnGuardarSucursal(nIdSucursal,nIdEmpresa,usuarioActivo.id_usuario,
                    ...
                    txtCodigoPostal.Text,chbUnica.Checked,nTipoPlantilla);
                if (nIdSucursal > 0)
                {
                    ...
                    {
                        clsComun.fnMostrarMensaje(this, Resources.resCorpusCFDIEs.varCorreosNoGuardados);
                    }
            ...
            {
                clsComun.fnMostrarMensaje(this, Resources.resCorpusCFDIEs.varSucursalGuardada);
                fnLimpiarCampos();
                fnActivarCampos(false);
                fnObtenerSucursales();
                btnNCancelar.Enabled=false;
        ...
        private void fnActivarCampos(bool activo)
        {
            ...
            ddlTipoPlantilla.Enabled = activo;
        }
        ...
        protected void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (nIdSucursal > 0)
            {
                ...
                if (dtSucursales.Rows.Count > 0)
                {
                    ...
                    ddlTipoPlantilla.SelectedIndex = ddlTipoPlantilla.Items.IndexOf(ddlTipoPlantilla.Items.FindByText(dtSucursales.Rows[0]["tipo_plantilla"].ToString()));
        ...
        protected void btnBorrar_Click(object sender, EventArgs e)
        {
            ...
            if (nIdSucursal > 0)
            {
                ...
                if (res > 0)
                {
                    clsComun.fnMostrarMensaje(this, Resources.resCorpusCFDIEs.varSucursalEliminada);
                    fnObtenerSucursales();

                }
                else
                {
                    clsComun.fnMostrarMensaje(this, Resources.resCorpusCFDIEs.varSucursalRelacion);
                }
            }
        }
        ...
        private void fnObtenerSucursales()
        {
            ...
            if (nIdEmpresa > 0)
            {
                ...
                {
                    ddlSucursales.Items.Add(new ListItem("<"+Resources.resCorpusCFDIEs.varEmpresaNoSucursal+">", "0"));
                    ddlSucursales.DataBind();
                    ddlSucursales.Enabled = false;
                    btnEditar.Enabled = false;
                    btnBorrar.Enabled = false;
            ...
            {
                ddlSucursales.Items.Add(new ListItem("<" + Resources.resCorpusCFDIEs.varRegistreEmpresa + ">", "0"));
                ddlSucursales.DataBind();
                ddlSucursales.Enabled = false;
                btnEditar.Enabled = false;
                btnBorrar.Enabled = false;
