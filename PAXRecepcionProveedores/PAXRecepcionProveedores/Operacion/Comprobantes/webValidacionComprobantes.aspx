<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="webValidacionComprobantes.aspx.cs" 
    Inherits="PAXRecepcionProveedores.Operacion.Comprobantes.webValidacionComprobantes" %>
...
//         $find(ModalProgress)._foregroundElement.style.zIndex += 10;
   ...
   <%-- <center>
    ...
    <table>
        <tr>
            <td>
                <asp:FileUpload ID="fuComprobantes" runat="server" Width="350px" />
        ...
        <tr>
            <td>
                ...
                <p><asp:FileUpload ID="fuPdf" runat="server" Width="350px"/></p>
            </td>
        </tr>
        <tr>
            <td>
