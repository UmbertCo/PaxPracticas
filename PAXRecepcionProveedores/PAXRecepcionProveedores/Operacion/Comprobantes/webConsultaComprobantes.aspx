<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="webConsultaComprobantes.aspx.cs" Inherits="PAXRecepcionProveedores.Operacion.Comprobantes.webConsultaComprobantes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="border: 2px ridge #9C1518; width: 973px;">
        <tr>
            <td>
                <table>
                <tr>
                    <td>
                        <table>
                            ...
                            <tr>
                                            ...
                                            <td align="right">
                                                   <asp:Button ID="btnBuscar" runat="server" Text="<%$ Resources:resCorpusCFDIEs, btnBuscar %>" OnClick="btnBuscar_Click" CssClass="botonEstiloVentanas" Width="80px"/>
                                                </div>
                                              </td>
                                        </tr>
                            </table>
                    ...
                    <ContentTemplate>
                        <asp:GridView ID="gvResultado" runat="server" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Estatus" ControlStyle-Width="100px"  >
                                    <ItemTemplate>
