<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="webInicioSesionRegistro.aspx.cs" Inherits="PAXRecepcionProveedores.InicioSesion.webInicioSesionRegistro" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
 <script type="text/javascript" language="javascript">
    ...
    <div >
         <asp:Panel ID="pnlcuentaN" runat="server" BorderColor="#FFFFFF" 
            BorderStyle="Solid" BorderWidth="1px" BackImageUrl="~/Imagenes/cuentaN.png"  
            Height="620px" Width="440px">
        <fieldset style="border-color:transparent" class="register" style="width: 420px" >
        <p align="center">
            
            <asp:Label ID="lblDatos" runat="server" ForeColor="White" 
                Text="<%$ Resources:resCorpusCFDIEs, lblDatos %>"></asp:Label>
            ...
            <p align="center">
                <asp:Label ID="lblUsuario" runat="server" AssociatedControlID="txtUsuario" 
                    Text="<%$ Resources:resCorpusCFDIEs, lblUsuario %>" ForeColor="White"></asp:Label>
            </p>
            <p align="center">
                ...
                <asp:RegularExpressionValidator ID="regxNueva" runat="server" 
                        ...
                        ToolTip="<%$ Resources:resCorpusCFDIEs, txtUsuario %>" Display="Dynamic"><img src="../Imagenes/error_sign.gif" /> </asp:RegularExpressionValidator>
            </p>
            <p align="center">
                <asp:Label ID="lblCorreo" runat="server" AssociatedControlID="txtCorreo" 
                    Text="<%$ Resources:resCorpusCFDIEs, lblCorreo %>" ForeColor="White"></asp:Label>
            ...
            <p align="center">
                <asp:CheckBox ID="chkAceptar" runat="server"
                    ...
                    oncheckedchanged="chkAceptar_CheckedChanged" ForeColor="White"  />
                ...
                <p align="center" style="font-family: 'century Gothic'; color: #FFFFFF;">
                    Captcha:
                    <br />
                    ...
                    <asp:TextBox ID="txtNumero" runat="server" EnableViewState="False" 
                        MaxLength="5" TabIndex="7" Width="130px"></asp:TextBox>
                ...
                <p>
                    <asp:Button ID="btnCrearCuenta" runat="server" CommandName="MoveNext" 
                        CssClass="botonGrandeRecupera" Enabled="False" Height="39px" 
                        onclick="btnCrearCuenta_Click" OnClientClick="clickOnce(this, 'Procesando')" 
                        TabIndex="8" Text="<%$ Resources:resCorpusCFDIEs, btnCrearCuenta %>" 
                        UseSubmitBehavior="false" ValidationGroup="RegisterUserValidationGroup" 
                        Width="272px" />
                </p>
