...
namespace PAXRecepcionProveedores.App_Code.GeneradorE_MAIL
{
    public class clsEnviaAcuseValidacion
    {
        ...
        public void fnEnviarAcuse(DataTable dtComprobantes, int nIdSucursal)
        {
            ...
            try
            {
                ...
                sMensaje.From = new MailAddress(this.strUsuario);
                ...
                //sMensaje.Body = plantilla.fnObtenerMensajeAcuseValidacion(dtComprobantes);
