...
using System.Data;
    ...
    public class clsOperacionProveedores
    {
        ...
        /// <summary>
        /// Obtiene los proveedores por filtro y por paginado
        /// </summary>
        /// <returns></returns>
        public DataTable fnObtenerProveedores( string sNombre, int nPagina, int nNumPagina)
        {
            DataTable res = new DataTable();
            try
            {
                ...
                giSql.AgregarParametro("@nNumPPagina", nNumPagina);

                giSql.Query("usp_rfp_Obtener_Proveedores_pag_sel", true, ref res);
            }
            catch (Exception ex)
            {
            }
