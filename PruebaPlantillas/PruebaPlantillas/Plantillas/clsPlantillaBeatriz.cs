...
using PruebaPlantillas;

/// <summary>
/// Clase encargada de recibir y manipular los datos de un XML (CFDI) para formar luego un archivo PDF
/// </summary>

namespace PlantillaBeatriz
{

    public class clsPlantillaBeatriz : ImplementadorPlantilla
    {
        #region atributos
