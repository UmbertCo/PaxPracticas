...
class clsPDFSharpNomina
{
    ...
    public string codigoBidimensional = string.Empty;
    ...
    public clsPDFSharpNomina(XmlDocument pxComprobante)
        {

            try { logo = XImage.FromFile(Settings.Default.Logo); }
            catch { clsLog.EscribirLog("Error al cargar el logo"); }
    ...
    public void fnGenerarPDF(string sRutaPDF, string sNombreTxt )
        {
            setISR(gxComprobante);

            this.codigoBidimensional = sNombreTxt;
            
            nomina = new PdfDocument();
            nomina.Info.Title = "CFDI";
            nomina.Info.Author = "CORPUS Facturacion";
            ...
            fuente1 = new XFont("Courier New", 14, XFontStyle.Bold);
            fuente2 = new XFont("Courier New", 12, XFontStyle.Regular);
            fuente3 = new XFont("Courier New", 8, XFontStyle.Bold);
            fuente4 = new XFont("Courier New", 8, XFontStyle.Regular);
            negrita = new XFont("Courier New", 12, XFontStyle.Bold);
    ...
    public void fnCrearPanelDatosEmpleado(ref XGraphics gfx)
    {
        ...
        gfx.DrawString("N.S.S:", negrita, XBrushes.Black, new Point(20, 190), formatoLeft);
        gfx.DrawString("Départamento:", negrita, XBrushes.Black, new Point(20, 200), formatoLeft);
    ...
    public void fnDatosPanelInformacionLaboral(XmlNamespaceManager nsmComprobante, XPathNavigator navEncabezado, ref XGraphics gfx)
    {
        ...
        sContrato = sDiasPagados = sSalarioBase  = sFechaPago = sJornada = sPeriodo = sAntiguedad = sSalarioDiario = sDelegacion = sFormaPago = sMetodoPago = sCLABE = sBanco = string.Empty;
