...
namespace UtileriasXML
{
      public  class GeneraXML
    {
        ...
        public GeneraXML(FileStream pfsruta,AdendaGenerica pagAdenda) 
        {
            srLector = new StreamReader(pfsruta);
            fnLeerTexo();
            fnObtenerLlaves();
            fnFormarXml();
        ...
        public GeneraXML(string psLayout,AdendaGenerica pagAdenda)
        {
        ...
        private void fnFormarXml() 
        {
            ...
            xdDocumento.DocumentElement.SetAttribute("schemaLocation","");
