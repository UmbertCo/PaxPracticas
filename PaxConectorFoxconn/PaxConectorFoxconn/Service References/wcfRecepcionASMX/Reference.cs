...
namespace PaxConectorFoxconn.wcfRecepcionASMX {
    ...
    public interface wcfRecepcionASMXSoap {
        ...
        PaxConectorFoxconn.wcfRecepcionASMX.fnEnviarXMLResponse fnEnviarXML(PaxConectorFoxconn.wcfRecepcionASMX.fnEnviarXMLRequest request);
    }
    ...
    public partial class fnEnviarXMLRequest {
        ...
        public PaxConectorFoxconn.wcfRecepcionASMX.fnEnviarXMLRequestBody Body;
        
        public fnEnviarXMLRequest() {
        }
        
        public fnEnviarXMLRequest(PaxConectorFoxconn.wcfRecepcionASMX.fnEnviarXMLRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class fnEnviarXMLResponse {
        ...
        public PaxConectorFoxconn.wcfRecepcionASMX.fnEnviarXMLResponseBody Body;
        
        public fnEnviarXMLResponse() {
        }
        
        public fnEnviarXMLResponse(PaxConectorFoxconn.wcfRecepcionASMX.fnEnviarXMLResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface wcfRecepcionASMXSoapChannel : PaxConectorFoxconn.wcfRecepcionASMX.wcfRecepcionASMXSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class wcfRecepcionASMXSoapClient : System.ServiceModel.ClientBase<PaxConectorFoxconn.wcfRecepcionASMX.wcfRecepcionASMXSoap>, PaxConectorFoxconn.wcfRecepcionASMX.wcfRecepcionASMXSoap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        PaxConectorFoxconn.wcfRecepcionASMX.fnEnviarXMLResponse PaxConectorFoxconn.wcfRecepcionASMX.wcfRecepcionASMXSoap.fnEnviarXML(PaxConectorFoxconn.wcfRecepcionASMX.fnEnviarXMLRequest request) {
        ...
        public string fnEnviarXML(string psComprobante, string psTipoDocumento, int pnId_Estructura, string sNombre, string sContraseña, string sVersion) {
            PaxConectorFoxconn.wcfRecepcionASMX.fnEnviarXMLRequest inValue = new PaxConectorFoxconn.wcfRecepcionASMX.fnEnviarXMLRequest();
            inValue.Body = new PaxConectorFoxconn.wcfRecepcionASMX.fnEnviarXMLRequestBody();
            ...
            PaxConectorFoxconn.wcfRecepcionASMX.fnEnviarXMLResponse retVal = ((PaxConectorFoxconn.wcfRecepcionASMX.wcfRecepcionASMXSoap)(this)).fnEnviarXML(inValue);
