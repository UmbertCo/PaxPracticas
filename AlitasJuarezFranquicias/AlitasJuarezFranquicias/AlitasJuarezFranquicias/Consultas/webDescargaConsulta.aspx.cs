...
public partial class Consultas_webDescargaConsulta : System.Web.UI.Page
{
    ...
    //        SqlConnection conexion = new SqlConnection(Utilerias.Encriptacion.Base64.DesencriptarBase64(cadena)+";Asynchronous Processing=true");
    //        conexion.Open();

    //        com = new SqlCommand("usp_Cfd_ComprobantesAsicronica_Franquicia_Sel", conexion);
    ...
    private void MetodoCallBack(SqlDataReader pReader)
    {
        ...
        columna12.Caption = "fecha_cancelacion";
        columna12.ColumnName = "fecha_cancelacion";
        ...
        columna15.Caption = "numero_ticket";
        columna15.ColumnName = "n_ticket";
        ...
        columna14.DataType = System.Type.GetType("System.String");
        columna14.AllowDBNull = true;
        columna14.Caption = "comentarios_cancelacion";
        columna14.ColumnName = "comentarios_cancelacion";
        columna14.DefaultValue = null;
        dtNew.Columns.Add(columna14);
        ...
        foreach (DataRow renglon in dtAuxiliar.Rows)
        {
            ...
            nuevo["n_ticket"] = renglon["n_ticket"];
    ...
    //    dtAuxiliar.Load(dr);
    //    //dtAuxiliar = (DataTable)Session["dtConsultaExc"];
    //    //com.Dispose();
    ...
    //private void MetodoCallBack()
    //{
    //    DataTable dtAuxiliar = new DataTable();
    //    //SqlDataReader dr = com.EndExecuteReader(result);
    //    //dtAuxiliar.Load(dr);
    //    GridView gvAuxiliar = (GridView)Session["dtConsultaExc"];
    //    //dtAuxiliar = (DataTable)Session["dtConsultaExc"];
    //    //com.Dispose();
    ...
    //    foreach (GridViewRow  renglon in gvAuxiliar.Rows)
    //    {
    //        DataRow nuevo = dtNew.NewRow();
    //        nuevo["UUID"] = renglon.FindControl("UUIDM");
    //        nuevo["serie"] = renglon.FindControl("serie");
    //        nuevo["folio"] = renglon.FindControl("folio");
    //        nuevo["razon_social"] = renglon.FindControl("razon_social");
    //        nuevo["sucursal"] = renglon.FindControl("sucursal");
    //        nuevo["documento"] = renglon.FindControl("documento");
    //        nuevo["total"] = renglon.FindControl("total");
    //        nuevo["moneda"] = renglon.FindControl("moneda");
    //        nuevo["fecha"] = renglon.FindControl("fecha");

    //        switch (Convert.ToString(renglon.FindControl("estatus")))
    //        {
    //            case "P":
    //                nuevo["estatus"] = "Pendiente";
    //                break;
    ...
    //                break;
    //            default:
    //                nuevo["estatus"] = renglon.FindControl("estatus");
    //                break;
    //        }



    //        nuevo["rfc"] = renglon.FindControl("rfc");
    //        nuevo["fecha_cancelacion"] = renglon.FindControl("fecha_cancelacion");
    //        nuevo["comentarios_cancelacion"] = renglon.FindControl("comentarios_cancelacion");
    //        dtNew.Rows.Add(nuevo);
    //    }
    //    ArrayList ejemplo = new ArrayList();
    //    ejemplo.Add("UUID");
    ...
    //Timer Actualiza el proceso del proceso de descarga
