...
public class clsEnvioSAT
{
                                   ...
                                   int idUsuario, XmlDocument sXmlDocument, int retornoInsert, clsInicioSesionUsuario datosUsuario)
    {
        ...
        //            if (retorno.ToUpper() == "COMPROBANTE RECHAZADO") //(retorno.Contains("S"))
        //            {   
        //                string sIncidencia = string.Empty;
        //                //Se lee nodo acuse
        //                XmlNodeList Acuse = docAcuseSat.GetElementsByTagName("Acuse");
        //                //Se lee nodos incidencia que contiene acuse
        //                XmlNodeList lista =
        //                ((XmlElement)Acuse[0]).GetElementsByTagName("Incidencia");
        //                int x = 0;
        //                //Se recorre nodos incidencia
        //                foreach (XmlElement nodo in lista)
        //                {
        //                    int i = 0;
        //                    XmlNodeList xMsjIncidencia = nodo.GetElementsByTagName("MensajeIncidencia");
        //                    XmlNodeList xCodError = nodo.GetElementsByTagName("CodigoError");

        //                    string sMsj = xMsjIncidencia[i].InnerText;
        //                    string sError = xCodError[i].InnerText;

        //                    if (x > 0)
        //                    { sIncidencia += "|"; }
        //                    //Se concatena mensaje de incidencia
        //                    sIncidencia += sError + " - " + sMsj;
        //                    x++;
        //                }
        ...
        //                                            "</td><td></td><td>" + sIncidencia +
        //                                            "</td><td></td><td>" + Convert.ToDateTime(docAcuseSat.DocumentElement.Attributes["Fecha"].Value) + "</td></tr>";
        //                strMensaje = strMensaje + "</table>";
        //                //Se regresa la mensaje con saltos de linea en caso de existir varias incidencias
        //                retorno = sIncidencia.Replace("|", "\n");
