...
public class clsInicioSesionSolicitudReg
{
    ...
    public bool fnSolicitudRegistroContribuyente(string psNombre, string psUsuario, byte[] psCorreo, byte[] psPassword,char psOrigen)
    {
        bool bRetorno=false;
    ...
    public int fnBuscarClaveExistente(string psUsuario, string psEmail)
    {
        ...
        using (SqlConnection con = new SqlConnection(PAXCrypto.CryptoAES.DesencriptaAES64(ConfigurationManager.ConnectionStrings["conInicioSesion"].ConnectionString)))
        {
            ...
            {
                con.Close();
                clsErrorLog.fnNuevaEntrada(ex, clsErrorLog.TipoErroresLog.Conexion, "buscarClaveExistente", "clsInicioSesionSolicitudReg");
            }
        }
        return nRetorno;
    }
    ...
    public DataTable fnBuscarUsuario(string psUsuario)
    {
        ...
        using (SqlConnection con = new SqlConnection(PAXCrypto.CryptoAES.DesencriptaAES64(ConfigurationManager.ConnectionStrings["conInicioSesion"].ConnectionString)))
        {
            ...
            {
                con.Close();
                clsErrorLog.fnNuevaEntrada(ex, clsErrorLog.TipoErroresLog.Conexion, "buscarUsuario", "clsInicioSesionSolicitudReg");
            }
        }
        return dtResultado;
    }
    ...
    /// <param name="psUsuario">Usuario del contribuyente</param>
    /// <returns>Regresa los datos del usuario</returns>
    public DataTable fnBuscarUsuarioRFC(string psUsuario)
    {
        DataTable dtResultado = new DataTable();
        ...
        using (SqlConnection con = new SqlConnection(PAXCrypto.CryptoAES.DesencriptaAES64(ConfigurationManager.ConnectionStrings["conInicioSesion"].ConnectionString)))
        {
            ...
            {
                con.Close();
                clsErrorLog.fnNuevaEntrada(ex, clsErrorLog.TipoErroresLog.Conexion, "buscarUsuarioRFC", "clsInicioSesionSolicitudReg");
            }
        }
        return dtResultado;
    }
    ...
    public DataTable fnRecuperaModulosUsuario(string psUsuario)
    {
        ...
        using (SqlConnection con = new SqlConnection(PAXCrypto.CryptoAES.DesencriptaAES64(ConfigurationManager.ConnectionStrings["conInicioSesion"].ConnectionString)))
        {
            ...
            {
                con.Close();
                clsErrorLog.fnNuevaEntrada(ex, clsErrorLog.TipoErroresLog.Conexion, "fnRecuperaModulosUsuario", "clsInicioSesionSolicitudReg");
            }
        }
        return dtResultado;
    }
    ...
    /// <param name="psPassword">Contraseña del contribuyente</param>
    /// <returns>Regresa una valor booleano para verificar el estatus</returns>
    public bool fnActualizaContraseña(string psUsuario, string psCorreo, byte[] psPassword)
    {
        bool bRetorno = false;
        ...
        using (SqlConnection con = new SqlConnection(PAXCrypto.CryptoAES.DesencriptaAES64(ConfigurationManager.ConnectionStrings["conInicioSesion"].ConnectionString)))
        {
            ...
            {
                con.Close();
                clsErrorLog.fnNuevaEntrada(ex, clsErrorLog.TipoErroresLog.Conexion, "actualizaContraseña", "clsInicioSesionSolicitudReg");
            }
        }
        return bRetorno;
    }
    ...
    /// <returns>Regresa una valor booleano para verificar el estatus</returns>
    public bool fnActualizaEstadoActual(string psUsuario, string psCorreo, char psEstadoActual)
    {
        bool bRetorno = false;
        ...
        using (SqlConnection con = new SqlConnection(PAXCrypto.CryptoAES.DesencriptaAES64(ConfigurationManager.ConnectionStrings["conInicioSesion"].ConnectionString)))
        {
            ...
            {
                con.Close();
                clsErrorLog.fnNuevaEntrada(ex, clsErrorLog.TipoErroresLog.Conexion, "actualizaEstadoActual", "clsInicioSesionSolicitudReg");
            }
        }
        return bRetorno;
    }
    ...
    /// <returns>Regresa una valor booleano para verificar el estatus</returns>
    public bool fnActualizaFechaIngreso(int pnId_Usuario, string psUsuario, string psCorreo)
    {
        bool bRetorno = false;
    ...
    /// <param name="psCorreo">Correo del contribuyente</param>
    /// <returns>Regresa una valor booleano para verificar el estatus</returns>
    public bool fnActualizaFechaCambio(int pnId_usuario, string psUsuario, string psCorreo)
    {
        bool bRetorno = false;
        ...
        using (SqlConnection con = new SqlConnection(PAXCrypto.CryptoAES.DesencriptaAES64(ConfigurationManager.ConnectionStrings["conInicioSesion"].ConnectionString)))
        {
            ...
            {
                con.Close();
                clsErrorLog.fnNuevaEntrada(ex, clsErrorLog.TipoErroresLog.Conexion, "actualizaFechaCambio", "clsInicioSesionSolicitudReg");
            }
        }
        return bRetorno;
    }
    ...
    /// <param name="psPassword">contraseña del contribuyente</param>
    /// <returns>Regresa una valor booleano para verificar el estatus</returns>
    public bool fnActualizaContraseñaCaducidad(int pnIdUsuario, char psTipo, byte[] psPassword)
    {
        bool bRetorno = false;
        ...
        using (SqlConnection con = new SqlConnection(PAXCrypto.CryptoAES.DesencriptaAES64(ConfigurationManager.ConnectionStrings["conInicioSesion"].ConnectionString)))
        {
            ...
            {
                con.Close();
                clsErrorLog.fnNuevaEntrada(ex, clsErrorLog.TipoErroresLog.Conexion, "actualizaContraseñaCaducidad", "clsInicioSesionSolicitudReg");
            }
        }
        return bRetorno;
    ...
    public bool fnRevisaInactividad(int pnIdUsuario)
    {
        ...
        using (SqlConnection con = new SqlConnection(PAXCrypto.CryptoAES.DesencriptaAES64(ConfigurationManager.ConnectionStrings["conInicioSesion"].ConnectionString)))
        {
            ...
            {
                con.Close();
                clsErrorLog.fnNuevaEntrada(ex, clsErrorLog.TipoErroresLog.Conexion, "RevisaInactividad", "clsInicioSesionSolicitudReg");
            }
        }
        return bRetorno;
    }
    ...
    public bool fnRevisaExpiracion(int pnIdUsuario)
    {
        ...
        using (SqlConnection con = new SqlConnection(PAXCrypto.CryptoAES.DesencriptaAES64(ConfigurationManager.ConnectionStrings["conInicioSesion"].ConnectionString)))
        {
            ...
            {
                con.Close();
                clsErrorLog.fnNuevaEntrada(ex, clsErrorLog.TipoErroresLog.Conexion, "RevisaExpiracion", "clsInicioSesionSolicitudReg");
            }
        }
        return bRetorno;
    }
    ...
    /// <param name="psPassword">contraseña del contribuyente</param>
    /// <returns>Regresa una valor booleano para verificar el estatus</returns>
    public bool fnRevisaPassRepetido(int pnIdUsuario, byte[] psPassword)
    {
        bool bRetorno = false;
        ...
        using (SqlConnection con = new SqlConnection(PAXCrypto.CryptoAES.DesencriptaAES64(ConfigurationManager.ConnectionStrings["conInicioSesion"].ConnectionString)))
        {
            ...
            {
                con.Close();
                clsErrorLog.fnNuevaEntrada(ex, clsErrorLog.TipoErroresLog.Conexion, "RevisaPassRepetido", "clsInicioSesionSolicitudReg");
            }
        }
        return bRetorno;
    }
