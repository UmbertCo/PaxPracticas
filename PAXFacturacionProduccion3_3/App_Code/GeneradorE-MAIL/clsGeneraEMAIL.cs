...
public class clsGeneraEMAIL
{
    ...
    public bool EnviarCorreo(string strMailTo, string strSubject,string strMensaje)
    {
        ...
        try
        {
            ...
            sMensaje.From = new System.Net.Mail.MailAddress(clsComun.fnObtenerParametro("emailAppFrom"));
            ...
            smtp.Host = clsComun.fnObtenerParametro("emailHost");
            smtp.DeliveryMethod = SmtpDeliveryMethod.Network;         
            smtp.Credentials = new System.Net.NetworkCredential(clsComun.fnObtenerParametro("emailUser"), PAXCrypto.CryptoAES.DesencriptaAES64(clsComun.fnObtenerParametro("emailPassword")));
            smtp.Port = Convert.ToInt32(clsComun.fnObtenerParametro("emailPort"));
            smtp.EnableSsl = true;
            smtp.Send(sMensaje);
        ...
        {
            bretorno=false;
            clsErrorLog.fnNuevaEntrada(ex, clsErrorLog.TipoErroresLog.Email, "EnviarCorreo", "clsGeneraEMAIL"); 
        }
    ...
    public bool EnviarCorreoticket(string strMailTo, string strSubject, string strMensaje, string strRuta)
    {
        ...
        {
            bretorno = false;
            clsErrorLog.fnNuevaEntrada(ex, clsErrorLog.TipoErroresLog.Email, "", "clsGeneraEMAIL");
        }
