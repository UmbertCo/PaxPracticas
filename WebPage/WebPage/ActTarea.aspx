<%@ Page Title="" Language="C#" MasterPageFile="~/Paginaprincipal.Master" AutoEventWireup="true"  validateRequest="false" CodeBehind="ActTarea.aspx.cs" Inherits="PAXActividades.ActTarea" %>
     ...
     <table>
        ...
        <tr>
            ...
            <br />
                ...
                Height="59px" Width="271px" TabIndex="2" MaxLength="200">
                </asp:TextBox>
            </td>
            <td>
