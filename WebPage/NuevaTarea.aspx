<%@ Page Title="" Language="C#" MasterPageFile="~/Paginaprincipal.Master" AutoEventWireup="true" validateRequest="false" CodeBehind="NuevaTarea.aspx.cs" Inherits="WebPage.WebForm8" %>
...
<div align="center">
    ...
    <p>
        ...
        <p>
                ...
                Height="106px" Width="510px" TabIndex="2" MaxLength="8000"></asp:TextBox>
