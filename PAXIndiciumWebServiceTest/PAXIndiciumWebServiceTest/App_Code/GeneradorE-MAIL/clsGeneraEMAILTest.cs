...
/// </summary>
public class clsGeneraEMAILTest
{
    ...
    public bool EnviarCorreo(string strMailTo, string strSubject, string strMensaje)
    {
        ...
        try
        {
            ...
            sMensaje.From = new System.Net.Mail.MailAddress(clsComunTest.fnObtenerParametro("emailAppFromWS"));
            ...
            smtp.Host = clsComunTest.fnObtenerParametro("emailHostWS");
            smtp.DeliveryMethod = SmtpDeliveryMethod.Network;
            smtp.Credentials = new System.Net.NetworkCredential(clsComunTest.fnObtenerParametro("emailAppFromWS"), Utilerias.Encriptacion.Classica.Desencriptar(clsComunTest.fnObtenerParametro("emailPasswordWS")));
            smtp.Port = Convert.ToInt32(clsComunTest.fnObtenerParametro("emailPortWS"));
            smtp.EnableSsl = true;
            smtp.Send(sMensaje);
        ...
        {
            bretorno = false;
            clsErrorLogTest.fnNuevaEntrada(ex, clsErrorLogTest.TipoErroresLog.Email);
        }
