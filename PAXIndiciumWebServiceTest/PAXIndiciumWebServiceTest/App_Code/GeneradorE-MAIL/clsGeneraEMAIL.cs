...
public class clsGeneraEMAIL
{
    ...
    public bool EnviarCorreo(string strMailTo, string strSubject, string strMensaje)
    {
        ...
        try
        {
            ...
            sMensaje.From = new System.Net.Mail.MailAddress(clsComun.fnObtenerParametro("emailAppFromWS"));
            ...
            smtp.Host = clsComun.fnObtenerParametro("emailHostWS");
            smtp.DeliveryMethod = SmtpDeliveryMethod.Network;
            smtp.Credentials = new System.Net.NetworkCredential(clsComun.fnObtenerParametro("emailAppFromWS"), Utilerias.Encriptacion.Classica.Desencriptar(clsComun.fnObtenerParametro("emailPasswordWS")));
            smtp.Port = Convert.ToInt32(clsComun.fnObtenerParametro("emailPortWS"));
            smtp.EnableSsl = true;
            smtp.Send(sMensaje);
