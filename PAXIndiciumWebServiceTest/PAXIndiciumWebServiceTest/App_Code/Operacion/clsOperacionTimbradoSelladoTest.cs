...
/// </summary>
public class clsOperacionTimbradoSelladoTest : IDisposable
{
    public clsOperacionTimbradoSelladoTest()
    {
    ...
    public clsOperacionTimbradoSelladoTest(byte[] pbLlave)
    {
        gbLlave = pbLlave;
    }
    ...
    public clsOperacionTimbradoSelladoTest(byte[] pbLlave, string psPassword)
    {
        gbLlave = pbLlave;
