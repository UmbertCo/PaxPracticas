...
/// </summary>
public class clsErrorLogTest
{
    private static clsInicioSesionUsuario gUsuario;

    public clsErrorLogTest()
    {
    }
    ...
    public static void fnNuevaEntrada(Exception pExcepcion, TipoErroresLog pTipoError, string psObservaciones, int pnId_Usuario)
    {
        ...
        sUbicacion = "Ubicado en Indicium Web Service Test";
        ...
        using (SqlConnection scConexion = new SqlConnection())
        {
            try
            {
                scConexion.ConnectionString = Utilerias.Encriptacion.Base64.DesencriptarBase64(ConfigurationManager.ConnectionStrings["conControlTest"].ConnectionString);
                scConexion.Open();
