...
public class clsValCertificadoTest
{
    ...
    /// <summary>
    /// Función que revisa si el certificado es un CSD
    /// </summary>
    /// <returns></returns>
    public bool fnEsCSD()
    {
    ...
    /// </summary>
    /// <returns></returns>
    public string fnObtenerNoCertificado()
    {
    ...
    public string fnValidarCertificado(string psRFC)
    {
        if (!fnEsCSD())
        {
    ...
    public string fnVerificarExistenciaCertificado()
    {
        ...
        string sNoCertificado = fnObtenerNoCertificado();
