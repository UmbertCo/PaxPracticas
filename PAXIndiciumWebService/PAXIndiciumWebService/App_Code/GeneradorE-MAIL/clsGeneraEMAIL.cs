...
public class clsGeneraEMAIL
{
    ...
    public bool EnviarCorreo(string strMailTo, string strSubject, string strMensaje)
    {
        ...
        try
        {
            ...
            sMensaje.From = new System.Net.Mail.MailAddress(clsComun.ObtenerParamentro("emailAppFromWS"));
            ...
            smtp.Host = clsComun.ObtenerParamentro("emailHostWS");
            smtp.DeliveryMethod = SmtpDeliveryMethod.Network;
            smtp.Credentials = new System.Net.NetworkCredential(clsComun.ObtenerParamentro("emailAppFromWS"), Utilerias.Encriptacion.Classica.Desencriptar(clsComun.ObtenerParamentro("emailPasswordWS")));
            smtp.Port = Convert.ToInt32(clsComun.ObtenerParamentro("emailPortWS"));
            smtp.EnableSsl = true;
            smtp.Send(sMensaje);
