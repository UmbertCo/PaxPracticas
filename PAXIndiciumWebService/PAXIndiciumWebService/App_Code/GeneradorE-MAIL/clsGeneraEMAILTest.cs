...
public class clsGeneraEMAILTest
{
    ...
    public bool EnviarCorreo(string strMailTo, string strSubject, string strMensaje)
    {
        ...
        try
        {
            ...
            sMensaje.From = new System.Net.Mail.MailAddress(clsComunTest.ObtenerParamentro("emailAppFromWS"));
            ...
            smtp.Host = clsComunTest.ObtenerParamentro("emailHostWS");
            smtp.DeliveryMethod = SmtpDeliveryMethod.Network;
            smtp.Credentials = new System.Net.NetworkCredential(clsComunTest.ObtenerParamentro("emailAppFromWS"), Utilerias.Encriptacion.Classica.Desencriptar(clsComunTest.ObtenerParamentro("emailPasswordWS")));
            smtp.Port = Convert.ToInt32(clsComunTest.ObtenerParamentro("emailPortWS"));
            smtp.EnableSsl = true;
            smtp.Send(sMensaje);
